...
struct PrimordialEssenceLoopMetrics {
    ...
    PrimordialEssenceLoopMetrics() = default;
};

// Main loop class
class PrimordialEssenceLoop {
public:
    // Initialization
    static bool Init(const PrimordialEssenceLoopConfig& config = PrimordialEssenceLoopConfig());
    ...
    // Configuration
    static void SetConfig(const PrimordialEssenceLoopConfig& config);
    static PrimordialEssenceLoopConfig GetConfig();
    
    // Metrics
    static PrimordialEssenceLoopMetrics GetMetrics();
...
private:
    ...
    static PrimordialEssenceLoopConfig s_config;
    static PrimordialEssenceLoopMetrics s_metrics;
