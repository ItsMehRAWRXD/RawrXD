// =============================================================================
// quick_amx_test.cpp
// Minimal working test for AMX/INT8 validation
// Compile: cl.exe /O2 /arch:AVX512 /EHsc quick_amx_test.cpp
// Or: g++ -O3 -march=native -o quick_amx_test.exe quick_amx_test.cpp
// =============================================================================
...
void timer_start(timer_t* t) { *t = clock(); }
double timer_elapsed_ms(timer_t* start) {
