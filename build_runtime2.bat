...
REM Tool paths (no quotes in set)
...
echo [1/5] Compiling SovereignSharedMemoryServer.cpp...
...
echo [2/5] Compiling SovereignRuntimeMain.cpp...
...
echo [3/5] Compiling SovereignRuntimeTestClient.cpp...
...
echo [4/5] Linking SovereignRuntime.exe...
