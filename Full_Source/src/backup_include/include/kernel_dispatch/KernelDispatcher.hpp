...
namespace RawrXD::Kernel {
    ...
    private:
        ...
        // Kernel function pointers (match actual ASM signatures)
        using PFN_PocketLabInit = int (*)(void);
        using PFN_PocketLabGetThermal = void (*)(void* snapshot_ptr);
        using PFN_PocketLabRunCycle = int64_t (*)(int64_t token_count);
        using PFN_PocketLabGetStats = void (*)(void* stats_buffer);
        ...
        PFN_PocketLabGetThermal m_pfn_pocket_lab_get_thermal;
        ...
        bool ResolveProcAddress(HMODULE dll, const char* proc_name, void*& out_proc);
