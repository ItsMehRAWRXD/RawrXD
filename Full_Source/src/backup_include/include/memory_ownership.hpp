...
struct AuditStats {
    ...
    AuditStats(const AuditStats& other)
        : totalAllocations(other.totalAllocations.load(std::memory_order_relaxed))
        , totalFrees(other.totalFrees.load(std::memory_order_relaxed))
        , activeAllocations(other.activeAllocations.load(std::memory_order_relaxed))
        , totalBytesAllocated(other.totalBytesAllocated.load(std::memory_order_relaxed))
        , totalBytesFreed(other.totalBytesFreed.load(std::memory_order_relaxed))
        , peakActiveBytes(other.peakActiveBytes.load(std::memory_order_relaxed))
        , violationCount(other.violationCount.load(std::memory_order_relaxed))
        , leaksDetected(other.leaksDetected.load(std::memory_order_relaxed))
        , doubleFreeDetected(other.doubleFreeDetected.load(std::memory_order_relaxed))
        , useAfterFreeDetected(other.useAfterFreeDetected.load(std::memory_order_relaxed))
        {}
    AuditStats& operator=(const AuditStats& other) {
        totalAllocations.store(other.totalAllocations.load(std::memory_order_relaxed), std::memory_order_relaxed);
        totalFrees.store(other.totalFrees.load(std::memory_order_relaxed), std::memory_order_relaxed);
        activeAllocations.store(other.activeAllocations.load(std::memory_order_relaxed), std::memory_order_relaxed);
        totalBytesAllocated.store(other.totalBytesAllocated.load(std::memory_order_relaxed), std::memory_order_relaxed);
        totalBytesFreed.store(other.totalBytesFreed.load(std::memory_order_relaxed), std::memory_order_relaxed);
        peakActiveBytes.store(other.peakActiveBytes.load(std::memory_order_relaxed), std::memory_order_relaxed);
        violationCount.store(other.violationCount.load(std::memory_order_relaxed), std::memory_order_relaxed);
        leaksDetected.store(other.leaksDetected.load(std::memory_order_relaxed), std::memory_order_relaxed);
        doubleFreeDetected.store(other.doubleFreeDetected.load(std::memory_order_relaxed), std::memory_order_relaxed);
        useAfterFreeDetected.store(other.useAfterFreeDetected.load(std::memory_order_relaxed), std::memory_order_relaxed);
        return *this;
    }
};
