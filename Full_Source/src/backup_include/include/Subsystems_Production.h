...
// <QHBoxLayout> removed (Qt-free build)
// Qt include removed (Qt-free build)
...
// <QPlainTextEdit> removed (Qt-free build)
// <QTabWidget> removed (Qt-free build)
// <QProgressBar> removed (Qt-free build)
// Qt include removed (Qt-free build)
// <QCheckBox> removed (Qt-free build)
// <QLineEdit> removed (Qt-free build)
// Qt include removed (Qt-free build)
// Qt include removed (Qt-free build)
// <QSettings> removed (Qt-free build)
