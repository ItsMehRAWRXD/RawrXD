...
extern "C" {
    ...
    int      asm_omega_plan_decompose(uint64_t requirementHash, uint32_t* taskIds, int maxTasks);
...
public:
    ...
    PatchResult planDecompose(uint64_t requirementHash, uint32_t* taskIds,
