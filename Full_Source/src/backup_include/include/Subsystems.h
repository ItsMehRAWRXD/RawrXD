...
class CodeLensProvider  { /* Q_OBJECT */ public: explicit CodeLensProvider(QObject* p=nullptr):QObject(p){} };
class InlayHintProvider  { /* Q_OBJECT */ public: explicit InlayHintProvider(QObject* p=nullptr):QObject(p){} };
class SemanticHighlighter  { /* Q_OBJECT */ public: explicit SemanticHighlighter(QObject* p=nullptr):QObject(p){} };
...
class StreamerClient  { /* Q_OBJECT */ public: explicit StreamerClient(QObject* p=nullptr):QObject(p){} };
class AgentOrchestrator  { /* Q_OBJECT */ public: explicit AgentOrchestrator(QObject* p=nullptr):QObject(p){} };
class AISuggestionOverlay  { /* Q_OBJECT */ public: explicit AISuggestionOverlay(QWidget* p=nullptr):QWidget(p){} };
class TaskProposalWidget  { /* Q_OBJECT */ public: explicit TaskProposalWidget(QWidget* p=nullptr):QWidget(p){} };
