...
private:
    ...
    std::string HandleCursorInlineEditRequest(const std::string& body);
    std::string HandleCursorDiffPreviewRequest(const std::string& body);
    std::string HandleCursorGhostTextRequest(const std::string& body);
    std::string HandleCursorContextRequest(const std::string& body);
    std::string HandleCursorKeystrokeRequest(const std::string& body);
    std::string HandleCursorMultiFileRequest(const std::string& body);
