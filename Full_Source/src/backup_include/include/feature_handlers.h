...
// ============================================================================
// AGENT GUI BRIDGE — When palette/menu runs agent/autonomy/subagent in GUI,
// core handlers delegate to Win32IDE (prompt dialog, AgenticBridge, local models).
// Implemented in Win32IDE_AgentCommands.cpp.
// ============================================================================
extern void RawrXD_InvokeAgentCommandGui(void* idePtr, int commandId);
...
// Bridge for GUI-only AI backend test (implemented in Win32IDE_Core.cpp)
extern void Win32IDE_runDebugTestAI(void* idePtr);
