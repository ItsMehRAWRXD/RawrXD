...
class ChatPanel {
    static currentPanel;
    static viewType = 'rawrxd.chatPanel';
    _panel;
    _disposables = [];
    _session;
    _ws;
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(ChatPanel.viewType, 'RawrXD Chat', column, {
            enableScripts: true,
    ...
    constructor(panel, extensionUri) {
        this._panel = panel;
        this._session = new chatSession_1.ChatSession();
