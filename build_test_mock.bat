@echo off
REM ============================================================================
REM build_test_mock.bat - Build ModelOperationsBridge Test with Mocks
REM ============================================================================
REM Uses mock headers to avoid C++23 std::expected dependency.
REM ============================================================================

echo [BUILD] ModelOperationsBridge Test with Mocks
echo ==============================================
...
REM Compile model_operations_bridge.cpp (with mock includes)
"%MSVC_ROOT%\bin\Hostx64\x64\cl.exe" /std:c++latest /EHsc /W3 /nologo /DWIN32 /D_WINDOWS /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /DNOMINMAX ^
    /I"src\test" /I"src" /I"src\core" /I"src\win32app" /I"src\logging" /I"3rdparty\nlohmann\single_include" ^
...
REM Compile test with mocks
"%MSVC_ROOT%\bin\Hostx64\x64\cl.exe" /std:c++latest /EHsc /W3 /nologo /DWIN32 /D_WINDOWS /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /DNOMINMAX ^
    /I"src\test" /I"src" /I"src\core" /I"src\win32app" /I"src\logging" /I"3rdparty\nlohmann\single_include" ^
    /c src\test\model_operations_bridge_test_mock.cpp /Fo"build\test\model_operations_bridge_test.obj"
if errorlevel 1 (
    echo [ERROR] Failed to compile model_operations_bridge_test_mock.cpp
    exit /b 1
)
