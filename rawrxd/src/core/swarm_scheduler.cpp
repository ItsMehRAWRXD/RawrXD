...
// ---------------------------------------------------------------------------
RawrXDModelLoaderMemoryBackend::RawrXDModelLoaderMemoryBackend(RawrXD::RawrXDModelLoader* loader) : m_loader(loader) {}
...
std::unique_ptr<SwarmScheduler> makeSwarmSchedulerWithLoader(RawrXD::RawrXDModelLoader* loader)
{
