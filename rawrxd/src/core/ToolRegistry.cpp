...
#ifndef RAWRXD_LEGACY_TOOL_REGISTRY_ALLOWED
    #error "Legacy ToolRegistry.cpp direct-process registry is disabled. Define RAWRXD_LEGACY_TOOL_REGISTRY_ALLOWED to enable (not recommended for production)."
#endif
