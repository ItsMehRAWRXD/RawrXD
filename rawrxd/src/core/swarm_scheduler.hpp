...
{
  public:
    explicit RawrXDModelLoaderMemoryBackend(RawrXD::RawrXDModelLoader* loader);
  ...
  private:
    RawrXD::RawrXDModelLoader* m_loader = nullptr;
    bool m_pinned = false;
...
[[nodiscard]] std::unique_ptr<SwarmScheduler> makeSwarmSchedulerWithLoader(RawrXD::RawrXDModelLoader* loader);
