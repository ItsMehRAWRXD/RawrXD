...
if(EXISTS "${CMAKE_SOURCE_DIR}/certs/rawrxd_product_layer_001.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target rawrxd_product_layer_001: missing certs/rawrxd_product_layer_001.cpp")
endif()

if(EXISTS "${CMAKE_SOURCE_DIR}/certs/rawrxd_product_layer_002.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target rawrxd_product_layer_002: missing certs/rawrxd_product_layer_002.cpp")
endif()
...
if(EXISTS "${CMAKE_SOURCE_DIR}/certs/rawrxd_product_layer_003.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target rawrxd_product_layer_003: missing certs/rawrxd_product_layer_003.cpp")
endif()
