...
if(EXISTS "${CMAKE_SOURCE_DIR}/src/cli/rawr_main.cpp")
  if(TARGET rawr)
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping agentic rawr CLI: missing src/cli/rawr_main.cpp and other agentic sources")
endif()
...
function(rawr_agent_cert name src)
  if(EXISTS "${CMAKE_SOURCE_DIR}/${src}")
    ...
    message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target ${name}: missing ${src}")
  endif()
endfunction()
...
if(EXISTS "${CMAKE_SOURCE_DIR}/certs/rawrxd_capability_solve_001.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target rawrxd_capability_solve_001: missing certs/rawrxd_capability_solve_001.cpp")
endif()

if(EXISTS "${CMAKE_SOURCE_DIR}/certs/rawrxd_qkv_rows_measure_001.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target rawrxd_qkv_rows_measure_001: missing certs/rawrxd_qkv_rows_measure_001.cpp")
endif()

if(EXISTS "${CMAKE_SOURCE_DIR}/certs/rawrxd_kernel_tune_001.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target rawrxd_kernel_tune_001: missing certs/rawrxd_kernel_tune_001.cpp")
endif()
...
if(EXISTS "${CMAKE_SOURCE_DIR}/certs/rawrxd_actual_e2e_generation_001.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target rawrxd_actual_e2e_generation_001: missing certs/rawrxd_actual_e2e_generation_001.cpp")
endif()

if(TARGET rawrxd_ge_probe_001)
