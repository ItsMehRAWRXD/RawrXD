...
if(EXISTS "${CMAKE_SOURCE_DIR}/src/deep2/Deep2Benchmark.cpp" AND EXISTS "${CMAKE_SOURCE_DIR}/src/deep2/deep2_benchmark_main.cpp")
    ...
    message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping deep2_benchmark: missing source files")
endif()

if(NOT TARGET k2_useful_tps_001 AND EXISTS "${CMAKE_SOURCE_DIR}/certs/k2_useful_tps_001.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target k2_useful_tps_001: missing certs/k2_useful_tps_001.cpp")
endif()

if(NOT TARGET mla_cert_001 AND EXISTS "${CMAKE_SOURCE_DIR}/certs/mla_cert_001.cpp")
  ...
  message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping cert target mla_cert_001: missing certs/mla_cert_001.cpp")
endif()
