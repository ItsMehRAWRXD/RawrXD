...
if(BUILD_DEEP2_PRODUCT_LAVAPATH AND TARGET InferenceEngine)
  if(EXISTS "${CMAKE_SOURCE_DIR}/src/deep2/lavapath/Deep2ProductLavapath.cpp" AND EXISTS "${CMAKE_SOURCE_DIR}/src/deep2/lavapath/Deep2ProductLavapath_Ops.cpp")
    ...
    message(STATUS "[RAWRXD_BUILD_SOURCE_INTEGRITY_001] Skipping deep2_product_lavapath: missing source files")
  endif()
endif()
