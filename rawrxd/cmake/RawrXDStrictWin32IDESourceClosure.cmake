...
if(_RAWRXD_MISSING_IDE_SOURCES)
    ...
    foreach(_rawrxd_missing IN LISTS _RAWRXD_MISSING_IDE_SOURCES)
        list(REMOVE_ITEM WIN32IDE_SOURCES "${_rawrxd_missing}")
        message(WARNING
            "[StrictIDEClosure] auto-removed absent concrete IDE source: ${_rawrxd_missing}")
    endforeach()
    list(LENGTH _RAWRXD_MISSING_IDE_SOURCES _rawrxd_missing_count)
    message(STATUS
        "[StrictIDEClosure] auto-removed ${_rawrxd_missing_count} absent concrete source entries from WIN32IDE_SOURCES. "
        "These become Batch 4 implementation obligations if referenced by headers.")
endif()
