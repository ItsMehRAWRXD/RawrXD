...
echo.
echo Testing compilation of test_headers.cpp...
echo This will verify all fixed headers compile cleanly.
echo.

cl /c /std:c++20 /EHsc %INCLUDE_FLAGS% test_headers.cpp 2>&1
if errorlevel 1 (
    echo.
    echo ========================================
...
echo ========================================
    echo All headers compile cleanly!
)
