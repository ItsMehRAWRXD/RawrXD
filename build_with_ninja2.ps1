...
& cmd.exe /c "cd D:\rawrxd && rmdir /s /q build_ninja2 & mkdir build_ninja2 & cd build_ninja2 && cmake -G Ninja -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CXX_FLAGS=\""/D_DEBUG /D_ITERATOR_DEBUG_LEVEL=2 /RTC1 /GS /guard:cf\"" .. && ninja"
