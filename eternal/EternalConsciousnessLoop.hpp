...
// Loop configuration
struct EternalConsciousnessLoopConfig {
    int targetTPS = 60;           // Target ticks per second
    int maxFPS = 60;              // Maximum frames per second
    bool enableFrameLimiting = true;
    bool enableMetrics = true;
    
    EternalConsciousnessLoopConfig() = default;
};

// Runtime metrics
struct EternalConsciousnessLoopMetrics {
    ...
    EternalConsciousnessLoopMetrics() = default;
};

// Main loop class
class EternalConsciousnessLoop {
public:
    // Initialization
    static bool Init(const EternalConsciousnessLoopConfig& config = EternalConsciousnessLoopConfig());
    ...
    // Configuration
    static void SetConfig(const EternalConsciousnessLoopConfig& config);
    static EternalConsciousnessLoopConfig GetConfig();
    
    // Metrics
    static EternalConsciousnessLoopMetrics GetMetrics();
...
private:
    ...
    static EternalConsciousnessLoopConfig s_config;
    static EternalConsciousnessLoopMetrics s_metrics;
