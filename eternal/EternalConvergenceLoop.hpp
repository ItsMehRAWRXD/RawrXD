...
struct EternalConvergenceMetrics {
    double eternalConvergenceCount = 0;
    double nodeCount = 0;
...
class EternalConvergenceLoop {
public:
    static EternalConvergenceLoop& GetInstance();
    ...
    EternalConvergenceMetrics GetMetrics() const;
    void ResetMetrics();
...
private:
    EternalConvergenceLoop() = default;
    ~EternalConvergenceLoop() { Stop(); }
    ...
    std::atomic<double> eternalResonance_{0.0};
    ...
    EternalConvergenceMetrics metrics_;
