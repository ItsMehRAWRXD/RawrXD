...
struct EternalVoidLoopMetrics {
    ...
    EternalVoidLoopMetrics() = default;
};

// Main loop class
class EternalVoidLoop {
public:
    // Initialization
    static bool Init(const EternalVoidLoopConfig& config = EternalVoidLoopConfig());
    ...
    // Configuration
    static void SetConfig(const EternalVoidLoopConfig& config);
    static EternalVoidLoopConfig GetConfig();
    
    // Metrics
    static EternalVoidLoopMetrics GetMetrics();
...
private:
    ...
    static EternalVoidLoopConfig s_config;
    static EternalVoidLoopMetrics s_metrics;
