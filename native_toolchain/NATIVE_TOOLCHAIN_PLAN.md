...
|-----------|----------|--------|----------|
| Native Assembler | ML64.EXE | 🔄 In Progress | P0 |
| Native Linker | LINK.EXE | ⏳ Not Started | P0 |
| Native Runtime | MS CRT | ⏳ Not Started | P0 |

### Phase 2: Libraries
| Component | Replaces | Status | Priority |
|-----------|----------|--------|----------|
| Native Librarian | LIB.EXE | ⏳ Not Started | P1 |
| Native Import Lib Gen | (implib) | ⏳ Not Started | P1 |

### Phase 3: Resources
| Component | Replaces | Status | Priority |
|-----------|----------|--------|----------|
| Native RC Compiler | RC.EXE | ⏳ Not Started | P2 |
...
```
Native Toolchain
├── Native Assembler (as.exe)
│   ├── Lexer (tokenizes .asm)
│   ├── Parser (builds AST)
│   ├── CodeGen (x64 machine code)
│   └── PE/COFF Writer (.obj)
│
├── Native Linker (ld.exe)
│   ├── Object File Reader (COFF)
│   ├── Symbol Resolution
│   ├── Section Merging
│   └── PE/EXE Writer
│
├── Native Runtime (rt.lib)
│   ├── Startup code (crt0.asm)
│   ├── Memory management
│   ├── String operations
│   └── I/O functions
│
├── Native Librarian (ar.exe)
│   └── Static library (.lib) creation
│
└── Native Resources (rc.exe)
...
- [ ] Can assemble .asm to .obj without ML64
- [ ] Can link .obj to .exe without LINK
- [ ] Can run without MS CRT
