...
$Script:statusFile = "d:\rawrxd\build_status.txt"
$Script:logFile = "d:\rawrxd\build_log_final.txt"

# Clean status
Remove-Item $statusFile -ErrorAction SilentlyContinue

Write-Host "Starting build..."
$Script:proc = Start-Process -FilePath "cmd.exe" -ArgumentList "/c `"d:\rawrxd\build_ide.bat`"" -NoNewWindow -RedirectStandardOutput $logFile -RedirectStandardError "d:\rawrxd\build_err.txt" -PassThru -Wait
