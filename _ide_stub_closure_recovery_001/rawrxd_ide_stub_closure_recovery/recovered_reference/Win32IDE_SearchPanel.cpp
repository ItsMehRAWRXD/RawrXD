// ============================================================================
// [SOURCE] win32app\Win32IDE_SearchPanel.cpp
// FILE: D:\rawrxd\src\win32app\Win32IDE_SearchPanel.cpp
// ============================================================================
...
void Win32IDE::createSearchPanel() {
    ...
    CreateWindowExA(0, "STATIC", "Search:", WS_CHILD | WS_VISIBLE,
        5, 5, 60, 20, m_hwndSidebar, nullptr, m_hInstance, nullptr);
    
    m_hwndSearchInput = CreateWindowExA(
        WS_EX_CLIENTEDGE, "EDIT", "",
        WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL,
        70, 5, m_sidebarWidth - 150, 20,
        m_hwndSidebar, nullptr, m_hInstance, nullptr);
    
    CreateWindowExA(0, "BUTTON", "Find", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        m_sidebarWidth - 75, 5, 70, 20, m_hwndSidebar, (HMENU)IDM_EDIT_FIND, m_hInstance, nullptr);
...
void Win32IDE::performSearch() {
    ...
    SetWindowTextA(m_hwndSearchInput, "");
}
