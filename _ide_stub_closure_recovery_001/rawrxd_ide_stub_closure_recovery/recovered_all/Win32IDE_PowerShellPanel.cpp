// ============================================================================
// [SOURCE] win32app\Win32IDE_PowerShellPanel.cpp
// FILE: D:\rawrxd\src\win32app\Win32IDE_PowerShellPanel.cpp
// ============================================================================
...
void Win32IDE::createPowerShellPanel() {
    ...
    SendMessage(m_hwndPowerShellOutput, EM_SETBKGNDCOLOR, FALSE, RGB(30, 30, 30));
    ...
    SendMessage(m_hwndPowerShellOutput, EM_SETCHARFORMAT, SCF_ALL, (LPARAM)&cf);
