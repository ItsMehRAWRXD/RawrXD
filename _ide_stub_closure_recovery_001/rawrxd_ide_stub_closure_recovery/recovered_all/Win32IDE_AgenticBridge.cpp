// ============================================================================
// [SOURCE] win32app\Win32IDE_AgenticBridge.cpp
...
// [CONSOLIDATED] #include "ModelNameValidator.h"
// [SYSINCLUDE] #include <sstream>
// [SYSINCLUDE] #include <algorithm>
// [SYSINCLUDE] #include <regex>
...
bool AgenticBridge::Initialize(const std::string& frameworkPath, const std::string& modelName) {
    ...
    // Set model if provided (permissive: BigDaddyG-F32-FROM-Q4 etc.)
    if (!modelName.empty()) {
        m_modelName = RawrXD::isValidModelName(modelName) ? modelName : RawrXD::sanitizeModelName(modelName);
    }
