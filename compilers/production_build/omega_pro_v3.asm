; omega_pro_v3.asm - Production Compiler
...
.data
    ...
    msg_banner db "Omega Pro v3 Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Omega Pro v3 Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Omega Pro v3 Compiler operational", 13, 10
