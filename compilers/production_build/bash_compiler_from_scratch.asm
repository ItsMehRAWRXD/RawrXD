; bash_compiler_from_scratch.asm - Production Compiler
...
.data
    ...
    msg_ready db "[READY] Bash Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Bash Compiler operational", 13, 10
