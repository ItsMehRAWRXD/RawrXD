; omega_pro.asm - Production Compiler
...
.data
    ...
    msg_banner db "Omega Pro Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Omega Pro Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Omega Pro Compiler operational", 13, 10
