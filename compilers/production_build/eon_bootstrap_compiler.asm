; eon_bootstrap_compiler.asm - Production Compiler
...
.data
    ...
    msg_ready db "[READY] EON Bootstrap Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - EON Bootstrap Compiler operational", 13, 10
