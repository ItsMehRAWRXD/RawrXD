; EON Compiler - x64 Assembly
; Compiles EON source files - FIXED VERSION
...
section .data
    ...
    msg_usage db "Usage: eon_compiler <file.eon>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_processing db "Parsing EON module...", 13, 10, 0
    msg_processing_len equ $ - msg_processing
    msg_success db "EON compilation complete!", 13, 10, 0
