; Java Compiler - x64 Assembly
; Compiles Java source files - FIXED VERSION

bits 64
default rel

section .data
    msg_banner db "Java Compiler v1.0", 13, 10
               db "Compiles Java to JVM bytecode", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: java_compiler <file.java>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_processing db "Processing Java source...", 13, 10, 0
    msg_processing_len equ $ - msg_processing
    msg_success db "Java compilation complete!", 13, 10, 0
