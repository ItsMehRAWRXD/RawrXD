; Python Compiler - x64 Assembly
; Compiles Python source files - FIXED VERSION

bits 64
default rel

section .data
    msg_banner db "Python Compiler v1.0", 13, 10
               db "Compiles Python to bytecode", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: python_compiler <file.py>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_processing db "Processing Python source...", 13, 10, 0
    msg_processing_len equ $ - msg_processing
    msg_success db "Python compilation complete!", 13, 10, 0
