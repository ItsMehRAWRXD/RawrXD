; PowerShell Compiler - x64 Assembly
; Compiles PowerShell scripts - FIXED VERSION

bits 64
default rel

section .data
    msg_banner db "PowerShell Compiler v1.0", 13, 10
               db "Compiles PowerShell scripts", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: powershell_compiler <file.ps1>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_processing db "Processing PowerShell script...", 13, 10, 0
    msg_processing_len equ $ - msg_processing
    msg_success db "PowerShell compilation complete!", 13, 10, 0
