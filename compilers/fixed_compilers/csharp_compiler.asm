; C# Compiler - x64 Assembly
; Compiles C# source files - FIXED VERSION

bits 64
default rel

section .data
    msg_banner db "C# Compiler v1.0", 13, 10
               db "Compiles C# to .NET IL", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: csharp_compiler <file.cs>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_processing db "Processing C# source...", 13, 10, 0
    msg_processing_len equ $ - msg_processing
    msg_success db "C# compilation complete!", 13, 10, 0
