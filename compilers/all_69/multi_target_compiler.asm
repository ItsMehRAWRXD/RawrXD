; multi_target_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "Multi Target Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Multi Target Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Multi Target Compiler operational", 13, 10
