; test_self_hosted_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "Test Self Hosted Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Test Self Hosted Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Test Self Hosted Compiler operational", 13, 10
