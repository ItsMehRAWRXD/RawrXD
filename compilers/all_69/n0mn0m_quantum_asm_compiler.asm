; n0mn0m_quantum_asm_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "N0mn0m Quantum Asm Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] N0mn0m Quantum Asm Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - N0mn0m Quantum Asm Compiler operational", 13, 10
