; self_contained_compiler_gui.asm - Production Compiler
...
.data
    ...
    msg_banner db "Self Contained Compiler Gui v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Self Contained Compiler Gui initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Self Contained Compiler Gui operational", 13, 10
