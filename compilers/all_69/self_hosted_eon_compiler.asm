; self_hosted_eon_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "Self Hosted Eon Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Self Hosted Eon Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Self Hosted Eon Compiler operational", 13, 10
