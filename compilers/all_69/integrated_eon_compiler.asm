; integrated_eon_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "Integrated Eon Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Integrated Eon Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Integrated Eon Compiler operational", 13, 10
