; move_compiler_from_scratch.asm - Production Compiler
...
.data
    ...
    msg_banner db "Move Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Move Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Move Compiler operational", 13, 10
