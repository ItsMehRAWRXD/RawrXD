; cross_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "Cross Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Cross Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Cross Compiler operational", 13, 10
