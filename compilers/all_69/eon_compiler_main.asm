; eon_compiler_main.asm - Production Compiler
...
.data
    ...
    msg_banner db "Eon Compiler Main v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Eon Compiler Main initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Eon Compiler Main operational", 13, 10
