; test_complete_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "Test Complete Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Test Complete Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Test Complete Compiler operational", 13, 10
