...
.data 
    ...
    msg_banner db "Cross-Platform v"Universal Compiler v1.0"", 13, 10 
    msg_banner_len equ $ - msg_banner 
 
    msg_ready db "[READY] Cross-Platform initialized", 13, 10 
    msg_ready_len equ $ - msg_ready 
 
    msg_test db "[TEST] PASS - Cross-Platform operational", 13, 10 
