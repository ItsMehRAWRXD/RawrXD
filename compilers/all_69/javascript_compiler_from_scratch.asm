; javascript_compiler_from_scratch.asm - Production Compiler
...
.data
    ...
    msg_ready db "[READY] Javascript Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Javascript Compiler operational", 13, 10
