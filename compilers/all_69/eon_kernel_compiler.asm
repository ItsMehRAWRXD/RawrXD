; eon_kernel_compiler.asm - Production Compiler
...
.data
    ...
    msg_banner db "Eon Kernel Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Eon Kernel Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Eon Kernel Compiler operational", 13, 10
