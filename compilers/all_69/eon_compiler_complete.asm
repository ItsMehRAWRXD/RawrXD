; eon_compiler_complete.asm - Production Compiler
...
.data
    ...
    msg_banner db "Eon Compiler Complete v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Eon Compiler Complete initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_test db "[TEST] PASS - Eon Compiler Complete operational", 13, 10
