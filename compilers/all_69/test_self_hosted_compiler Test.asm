...
.data 
    ...
    msg_banner db "Self-Hosted v"Test Compiler v1.0"", 13, 10 
    msg_banner_len equ $ - msg_banner 
 
    msg_ready db "[READY] Self-Hosted initialized", 13, 10 
    msg_ready_len equ $ - msg_ready 
 
    msg_test db "[TEST] PASS - Self-Hosted operational", 13, 10 
