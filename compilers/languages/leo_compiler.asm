...
section .data
    msg_banner db "RawrXD leo Compiler v1.0", 13, 10
               db "Compiles leo source", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: leo_compiler <file.leo>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_open_err db "Error: Cannot open file", 13, 10, 0
    msg_open_err_len equ $ - msg_open_err
    msg_success db "leo source processed successfully", 13, 10, 0
    msg_success_len equ $ - msg_success
    msg_parsing db "Parsing leo source...", 13, 10, 0
