...
section .data
    msg_banner db "RawrXD Java Compiler v1.0", 13, 10
               db "Compiles Java source to bytecode", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: java_compiler <file.java>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_open_err db "Error: Cannot open file", 13, 10, 0
    msg_open_err_len equ $ - msg_open_err
    msg_read_err db "Error: Cannot read file", 13, 10, 0
    msg_read_err_len equ $ - msg_read_err
    msg_success db "Java source processed successfully", 13, 10, 0
    msg_success_len equ $ - msg_success
    msg_parsing db "Parsing Java source...", 13, 10, 0
    msg_parsing_len equ $ - msg_parsing
    msg_token db "Token: ", 0
    msg_token_len equ $ - msg_token
