...
section .data
    msg_banner db "RawrXD ink Compiler v1.0", 13, 10
               db "Compiles ink source", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: ink_compiler <file.ink>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_open_err db "Error: Cannot open file", 13, 10, 0
    msg_open_err_len equ $ - msg_open_err
    msg_success db "ink source processed successfully", 13, 10, 0
    msg_success_len equ $ - msg_success
    msg_parsing db "Parsing ink source...", 13, 10, 0
