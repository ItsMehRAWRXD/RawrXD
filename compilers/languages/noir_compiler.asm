...
section .data
    msg_banner db "RawrXD noir Compiler v1.0", 13, 10
               db "Compiles noir source", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: noir_compiler <file.nr>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_open_err db "Error: Cannot open file", 13, 10, 0
    msg_open_err_len equ $ - msg_open_err
    msg_success db "noir source processed successfully", 13, 10, 0
    msg_success_len equ $ - msg_success
    msg_parsing db "Parsing noir source...", 13, 10, 0
