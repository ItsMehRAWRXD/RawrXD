...
section .data
    msg_banner db "RawrXD php Compiler v1.0", 13, 10
               db "Compiles php source", 13, 10, 0
    msg_banner_len equ $ - msg_banner
    msg_usage db "Usage: php_compiler <file.php>", 13, 10, 0
    msg_usage_len equ $ - msg_usage
    msg_open_err db "Error: Cannot open file", 13, 10, 0
    msg_open_err_len equ $ - msg_open_err
    msg_success db "php source processed successfully", 13, 10, 0
    msg_success_len equ $ - msg_success
    msg_parsing db "Parsing php source...", 13, 10, 0
