; ada_compiler_from_scratch.asm - Production Compiler 
...
.data 
    hStdOut dq 0 
    bytes_written dq 0 
    msg_banner db "Ada Compiler v1.0", 13, 10 
    msg_banner_len equ $ - msg_banner 
    msg_ready db "[READY] Ada Compiler initialized", 13, 10 
    msg_ready_len equ $ - msg_ready 
    msg_test db "[TEST] PASS - Ada Compiler operational", 13, 10 
