# Build All 69 Compilers - PowerShell Version
...
$OUTDIR = "d:\rawrxd\compilers\all_69_working_v2"

New-Item -ItemType Directory -Force -Path $OUTDIR | Out-Null

Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host "Building All 69 Compilers - PowerShell Version" -ForegroundColor Cyan
...
foreach ($compiler in $compilers) {
    ...
    # Generate assembly
    $asmContent = @"
; $($compiler.Display) v$($compiler.Version)
...
.data
    hStdOut dq 0
    bytes_written dq 0
    msg_banner db "$($compiler.Display) v$($compiler.Version)", 13, 10
    msg_banner_len equ `$ - msg_banner
    msg_ready db "[READY] $($compiler.Category) compiler operational", 13, 10
...
"@
    ...
    # Write assembly file
    $asmContent | Out-File -FilePath $asmPath -Encoding ASCII
