; motoko_compiler_from_scratch v1.0
...
.data
    hStdOut dq 0
    bytes_written dq 0
    msg_banner db "motoko_compiler_from_scratch v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    msg_ready db "[READY] motoko_compiler_from_scratch initialized", 13, 10
