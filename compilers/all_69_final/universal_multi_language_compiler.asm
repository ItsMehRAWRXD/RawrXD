; universal_multi_language_compiler v1.0
...
.data
    hStdOut dq 0
    bytes_written dq 0
    msg_banner db "universal_multi_language_compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    msg_ready db "[READY] universal_multi_language_compiler initialized", 13, 10
