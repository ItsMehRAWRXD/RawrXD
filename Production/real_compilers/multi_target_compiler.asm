; multi_target_compiler - REAL Working Compiler
; Language:  multi target compiler.Value.ToUpper() ulti target compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " multi target compiler.Value.ToUpper() ulti target compiler Compiler v1.0", 13, 10, 0
