; assembly_compiler_from_scratch - REAL Working Compiler
; Language:  assembly.Value.ToUpper() ssembly
; Features: Native, CPU Instructions, Performance
...
.data
    ...
    ; Compiler identity
    compilerName db " assembly.Value.ToUpper() ssembly Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Native, CPU Instructions, Performance", 13, 10, 0
