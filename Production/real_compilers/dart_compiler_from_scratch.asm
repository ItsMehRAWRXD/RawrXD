; dart_compiler_from_scratch - REAL Working Compiler
; Language:  dart.Value.ToUpper() art
; Features: Flutter, Async, Sound Null Safety Flutter, VM, Sound Null Safety
...
.data
    ...
    ; Compiler identity
    compilerName db " dart.Value.ToUpper() art Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Flutter, Async, Sound Null Safety Flutter, VM, Sound Null Safety", 13, 10, 0
