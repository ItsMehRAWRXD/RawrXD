; powershell_compiler_from_scratch - REAL Working Compiler
; Language:  powershell.Value.ToUpper() owershell
; Features: Cmdlets, Objects, Pipeline, .NET Integration
...
.data
    ...
    ; Compiler identity
    compilerName db " powershell.Value.ToUpper() owershell Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Cmdlets, Objects, Pipeline, .NET Integration", 13, 10, 0
