; eon_compiler_main - REAL Working Compiler
; Language:  eon compiler main.Value.ToUpper() on compiler main
...
.data
    ...
    ; Compiler identity
    compilerName db " eon compiler main.Value.ToUpper() on compiler main Compiler v1.0", 13, 10, 0
