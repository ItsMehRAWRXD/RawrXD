; matlab_compiler_from_scratch - REAL Working Compiler
; Language:  matlab.Value.ToUpper() atlab
; Features: Matrix Ops, Simulink, Toolboxes
...
.data
    ...
    ; Compiler identity
    compilerName db " matlab.Value.ToUpper() atlab Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Matrix Ops, Simulink, Toolboxes", 13, 10, 0
