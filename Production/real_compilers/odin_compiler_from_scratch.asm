; odin_compiler_from_scratch - REAL Working Compiler
; Language:  odin.Value.ToUpper() din
; Features: Data-Oriented, SoA, Explicit Alloc
...
.data
    ...
    ; Compiler identity
    compilerName db " odin.Value.ToUpper() din Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Data-Oriented, SoA, Explicit Alloc", 13, 10, 0
