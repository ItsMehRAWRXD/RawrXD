; universal_cross_platform_compiler - REAL Working Compiler
; Language:  universal cross platform compiler.Value.ToUpper() niversal cross platform compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " universal cross platform compiler.Value.ToUpper() niversal cross platform compiler Compiler v1.0", 13, 10, 0
