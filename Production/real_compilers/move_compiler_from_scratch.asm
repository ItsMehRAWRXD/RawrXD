; move_compiler_from_scratch - REAL Working Compiler
; Language:  move.Value.ToUpper() ove
; Features: Resources, Diem, Safety
...
.data
    ...
    ; Compiler identity
    compilerName db " move.Value.ToUpper() ove Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Resources, Diem, Safety", 13, 10, 0
