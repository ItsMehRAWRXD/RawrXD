; webassembly_compiler_from_scratch - REAL Working Compiler
; Language:  webassembly.Value.ToUpper() ebassembly
...
.data
    ...
    ; Compiler identity
    compilerName db " webassembly.Value.ToUpper() ebassembly Compiler v1.0", 13, 10, 0
