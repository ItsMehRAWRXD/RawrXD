; integrated_eon_compiler - REAL Working Compiler
; Language:  integrated eon compiler.Value.ToUpper() ntegrated eon compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " integrated eon compiler.Value.ToUpper() ntegrated eon compiler Compiler v1.0", 13, 10, 0
