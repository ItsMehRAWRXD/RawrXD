; erlang_compiler_from_scratch - REAL Working Compiler
; Language:  erlang.Value.ToUpper() rlang
; Features: Actor Model, Fault Tolerance, OTP BEAM, Actor Model, OTP
...
.data
    ...
    ; Compiler identity
    compilerName db " erlang.Value.ToUpper() rlang Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Actor Model, Fault Tolerance, OTP BEAM, Actor Model, OTP", 13, 10, 0
