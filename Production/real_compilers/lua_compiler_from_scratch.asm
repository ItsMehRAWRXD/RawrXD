; lua_compiler_from_scratch - REAL Working Compiler
; Language:  lua.Value.ToUpper() ua
; Features: Embeddable, Tables, Coroutines, Metatables Embeddable, Tables, Coroutines
...
.data
    ...
    ; Compiler identity
    compilerName db " lua.Value.ToUpper() ua Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Embeddable, Tables, Coroutines, Metatables Embeddable, Tables, Coroutines", 13, 10, 0
