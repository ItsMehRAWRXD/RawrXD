; pascal_compiler_from_scratch - REAL Working Compiler
; Language:  pascal.Value.ToUpper() ascal
; Features: Strong Typing, Records, Units, Delphi Compat
...
.data
    ...
    ; Compiler identity
    compilerName db " pascal.Value.ToUpper() ascal Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Strong Typing, Records, Units, Delphi Compat", 13, 10, 0
