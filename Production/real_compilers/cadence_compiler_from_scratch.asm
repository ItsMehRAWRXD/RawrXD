; cadence_compiler_from_scratch - REAL Working Compiler
; Language:  cadence.Value.ToUpper() adence
...
.data
    ...
    ; Compiler identity
    compilerName db " cadence.Value.ToUpper() adence Compiler v1.0", 13, 10, 0
