; clojure_compiler_from_scratch - REAL Working Compiler
; Language:  clojure.Value.ToUpper() lojure
; Features: Lisp, Immutability, STM, JVM JVM, Lisp, STM
...
.data
    ...
    ; Compiler identity
    compilerName db " clojure.Value.ToUpper() lojure Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Lisp, Immutability, STM, JVM JVM, Lisp, STM", 13, 10, 0
