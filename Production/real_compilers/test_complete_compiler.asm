; test_complete_compiler - REAL Working Compiler
; Language:  test complete compiler.Value.ToUpper() est complete compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " test complete compiler.Value.ToUpper() est complete compiler Compiler v1.0", 13, 10, 0
