; ada_compiler_from_scratch - REAL Working Compiler
; Language:  ada.Value.ToUpper() da
; Features: Safety, Contracts, Tasks, Ravenscar
...
.data
    ...
    ; Compiler identity
    compilerName db " ada.Value.ToUpper() da Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Safety, Contracts, Tasks, Ravenscar", 13, 10, 0
