; uber_elegant_compiler - REAL Working Compiler
; Language:  uber elegant compiler.Value.ToUpper() ber elegant compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " uber elegant compiler.Value.ToUpper() ber elegant compiler Compiler v1.0", 13, 10, 0
