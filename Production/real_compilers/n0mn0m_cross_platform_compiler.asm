; n0mn0m_cross_platform_compiler - REAL Working Compiler
; Language:  n0mn0m cross platform compiler.Value.ToUpper() 0mn0m cross platform compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " n0mn0m cross platform compiler.Value.ToUpper() 0mn0m cross platform compiler Compiler v1.0", 13, 10, 0
