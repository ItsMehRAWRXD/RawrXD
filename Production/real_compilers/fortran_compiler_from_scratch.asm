; fortran_compiler_from_scratch - REAL Working Compiler
; Language:  fortran.Value.ToUpper() ortran
; Features: Scientific Computing, Arrays, Parallelism
...
.data
    ...
    ; Compiler identity
    compilerName db " fortran.Value.ToUpper() ortran Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Scientific Computing, Arrays, Parallelism", 13, 10, 0
