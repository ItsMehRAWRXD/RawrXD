; scala_compiler_from_scratch - REAL Working Compiler
; Language:  scala.Value.ToUpper() cala
; Features: Functional + OOP, Akka, Spark JVM, Functional, Akka
...
.data
    ...
    ; Compiler identity
    compilerName db " scala.Value.ToUpper() cala Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Functional + OOP, Akka, Spark JVM, Functional, Akka", 13, 10, 0
