; haskell_compiler_from_scratch - REAL Working Compiler
; Language:  haskell.Value.ToUpper() askell
; Features: Pure Functions, Monads, Type Classes, Laziness
...
.data
    ...
    ; Compiler identity
    compilerName db " haskell.Value.ToUpper() askell Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Pure Functions, Monads, Type Classes, Laziness", 13, 10, 0
