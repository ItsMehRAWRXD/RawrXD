; cross_compiler - REAL Working Compiler
; Language:  cross compiler.Value.ToUpper() ross compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " cross compiler.Value.ToUpper() ross compiler Compiler v1.0", 13, 10, 0
