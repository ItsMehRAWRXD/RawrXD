; delphi_compiler_from_scratch - REAL Working Compiler
; Language:  delphi.Value.ToUpper() elphi
; Features: Object Pascal, VCL, RAD
...
.data
    ...
    ; Compiler identity
    compilerName db " delphi.Value.ToUpper() elphi Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Object Pascal, VCL, RAD", 13, 10, 0
