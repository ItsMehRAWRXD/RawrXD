; reverser_compiler - REAL Working Compiler
; Language:  reverser compiler.Value.ToUpper() everser compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " reverser compiler.Value.ToUpper() everser compiler Compiler v1.0", 13, 10, 0
