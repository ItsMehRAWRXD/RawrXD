; typescript_compiler_from_scratch - REAL Working Compiler
; Language:  typescript.Value.ToUpper() ypescript
; Features: Types, Interfaces, Generics, Decorators Typed JavaScript, Microsoft
...
.data
    ...
    ; Compiler identity
    compilerName db " typescript.Value.ToUpper() ypescript Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Types, Interfaces, Generics, Decorators Typed JavaScript, Microsoft", 13, 10, 0
