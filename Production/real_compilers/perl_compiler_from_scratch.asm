; perl_compiler_from_scratch - REAL Working Compiler
; Language:  perl.Value.ToUpper() erl
; Features: Regex, Text Processing, CPAN, Context Text Processing, Regex, CPAN
...
.data
    ...
    ; Compiler identity
    compilerName db " perl.Value.ToUpper() erl Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Regex, Text Processing, CPAN, Context Text Processing, Regex, CPAN", 13, 10, 0
