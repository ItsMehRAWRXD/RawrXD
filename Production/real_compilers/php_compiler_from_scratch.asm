; php_compiler_from_scratch - REAL Working Compiler
; Language:  php.Value.ToUpper() hp
; Features: Web-focused, Dynamic Types, Namespaces Web, Server-side, WordPress
...
.data
    ...
    ; Compiler identity
    compilerName db " php.Value.ToUpper() hp Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Web-focused, Dynamic Types, Namespaces Web, Server-side, WordPress", 13, 10, 0
