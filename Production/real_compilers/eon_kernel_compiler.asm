; eon_kernel_compiler - REAL Working Compiler
; Language:  eon kernel compiler.Value.ToUpper() on kernel compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " eon kernel compiler.Value.ToUpper() on kernel compiler Compiler v1.0", 13, 10, 0
