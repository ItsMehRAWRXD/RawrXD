; elixir_compiler_from_scratch - REAL Working Compiler
; Language:  elixir.Value.ToUpper() lixir
; Features: Phoenix, Macros, Pipe Operator Erlang VM, Phoenix, Macros
...
.data
    ...
    ; Compiler identity
    compilerName db " elixir.Value.ToUpper() lixir Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Phoenix, Macros, Pipe Operator Erlang VM, Phoenix, Macros", 13, 10, 0
