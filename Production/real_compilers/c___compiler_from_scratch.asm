; c___compiler_from_scratch - REAL Working Compiler
; Language:  c  .Value.ToUpper()   
; Features: Pointers, Memory Management, Preprocessor, Structs
...
.data
    ...
    ; Compiler identity
    compilerName db " c  .Value.ToUpper()    Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Pointers, Memory Management, Preprocessor, Structs", 13, 10, 0
