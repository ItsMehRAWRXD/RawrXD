; universal_compiler_runtime_clean - REAL Working Compiler
; Language:  universal compiler runtime clean.Value.ToUpper() niversal compiler runtime clean
...
.data
    ...
    ; Compiler identity
    compilerName db " universal compiler runtime clean.Value.ToUpper() niversal compiler runtime clean Compiler v1.0", 13, 10, 0
