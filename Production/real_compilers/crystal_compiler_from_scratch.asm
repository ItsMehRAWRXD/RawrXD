; crystal_compiler_from_scratch - REAL Working Compiler
; Language:  crystal.Value.ToUpper() rystal
; Features: Ruby-like, Static Types, LLVM
...
.data
    ...
    ; Compiler identity
    compilerName db " crystal.Value.ToUpper() rystal Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Ruby-like, Static Types, LLVM", 13, 10, 0
