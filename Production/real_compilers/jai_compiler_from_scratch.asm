; jai_compiler_from_scratch - REAL Working Compiler
; Language:  jai.Value.ToUpper() ai
; Features: Game Dev, Data-Oriented, Metaprogramming
...
.data
    ...
    ; Compiler identity
    compilerName db " jai.Value.ToUpper() ai Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Game Dev, Data-Oriented, Metaprogramming", 13, 10, 0
