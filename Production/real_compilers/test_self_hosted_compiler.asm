; test_self_hosted_compiler - REAL Working Compiler
; Language:  test self hosted compiler.Value.ToUpper() est self hosted compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " test self hosted compiler.Value.ToUpper() est self hosted compiler Compiler v1.0", 13, 10, 0
