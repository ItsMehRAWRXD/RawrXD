; full_eon_compiler - REAL Working Compiler
; Language:  full eon compiler.Value.ToUpper() ull eon compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " full eon compiler.Value.ToUpper() ull eon compiler Compiler v1.0", 13, 10, 0
