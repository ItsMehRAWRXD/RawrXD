; self_contained_compiler_gui - REAL Working Compiler
; Language:  self contained compiler gui.Value.ToUpper() elf contained compiler gui
...
.data
    ...
    ; Compiler identity
    compilerName db " self contained compiler gui.Value.ToUpper() elf contained compiler gui Compiler v1.0", 13, 10, 0
