; reverser_compiler_from_scratch - REAL Working Compiler
; Language:  reverser.Value.ToUpper() everser
...
.data
    ...
    ; Compiler identity
    compilerName db " reverser.Value.ToUpper() everser Compiler v1.0", 13, 10, 0
