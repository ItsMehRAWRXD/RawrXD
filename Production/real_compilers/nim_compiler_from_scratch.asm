; nim_compiler_from_scratch - REAL Working Compiler
; Language:  nim.Value.ToUpper() im
; Features: Metaprogramming, C Backend, Macros
...
.data
    ...
    ; Compiler identity
    compilerName db " nim.Value.ToUpper() im Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Metaprogramming, C Backend, Macros", 13, 10, 0
