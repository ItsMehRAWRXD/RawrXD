; ocaml_compiler_from_scratch - REAL Working Compiler
; Language:  ocaml.Value.ToUpper() caml
; Features: Pattern Matching, Type Inference, Functors
...
.data
    ...
    ; Compiler identity
    compilerName db " ocaml.Value.ToUpper() caml Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Pattern Matching, Type Inference, Functors", 13, 10, 0
