; eon_compiler_complete - REAL Working Compiler
; Language:  eon compiler complete.Value.ToUpper() on compiler complete
...
.data
    ...
    ; Compiler identity
    compilerName db " eon compiler complete.Value.ToUpper() on compiler complete Compiler v1.0", 13, 10, 0
