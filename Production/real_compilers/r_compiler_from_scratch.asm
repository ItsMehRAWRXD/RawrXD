; r_compiler_from_scratch - REAL Working Compiler
; Language:  r.Value.ToUpper() 
; Features: Statistics, Data Frames, Vectorized Ops
...
.data
    ...
    ; Compiler identity
    compilerName db " r.Value.ToUpper()  Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Statistics, Data Frames, Vectorized Ops", 13, 10, 0
