; zig_compiler_from_scratch - REAL Working Compiler
; Language:  zig.Value.ToUpper() ig
; Features: Comptime, C Interop, Safety
...
.data
    ...
    ; Compiler identity
    compilerName db " zig.Value.ToUpper() ig Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Comptime, C Interop, Safety", 13, 10, 0
