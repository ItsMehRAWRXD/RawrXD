; julia_compiler_from_scratch - REAL Working Compiler
; Language:  julia.Value.ToUpper() ulia
; Features: Multiple Dispatch, JIT, Linear Algebra
...
.data
    ...
    ; Compiler identity
    compilerName db " julia.Value.ToUpper() ulia Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Multiple Dispatch, JIT, Linear Algebra", 13, 10, 0
