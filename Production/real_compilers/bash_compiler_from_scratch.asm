; bash_compiler_from_scratch - REAL Working Compiler
; Language:  bash.Value.ToUpper() ash
; Features: POSIX Shell, Variables, Control Flow, Functions, Pipes
...
.data
    ...
    ; Compiler identity
    compilerName db " bash.Value.ToUpper() ash Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] POSIX Shell, Variables, Control Flow, Functions, Pipes", 13, 10, 0
