; rust_compiler_from_scratch - REAL Working Compiler
; Language:  rust.Value.ToUpper() ust
; Features: Ownership, Borrowing, Lifetimes, Pattern Matching
...
.data
    ...
    ; Compiler identity
    compilerName db " rust.Value.ToUpper() ust Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Ownership, Borrowing, Lifetimes, Pattern Matching", 13, 10, 0
