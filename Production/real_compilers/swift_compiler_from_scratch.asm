; swift_compiler_from_scratch - REAL Working Compiler
; Language:  swift.Value.ToUpper() wift
; Features: Optionals, ARC, Protocols, Generics iOS, macOS, Server, TensorFlow
...
.data
    ...
    ; Compiler identity
    compilerName db " swift.Value.ToUpper() wift Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Optionals, ARC, Protocols, Generics iOS, macOS, Server, TensorFlow", 13, 10, 0
