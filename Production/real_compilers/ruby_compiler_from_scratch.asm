; ruby_compiler_from_scratch - REAL Working Compiler
; Language:  ruby.Value.ToUpper() uby
; Features: Metaprogramming, Blocks, Mixins, Symbols Metaprogramming, Rails, Blocks
...
.data
    ...
    ; Compiler identity
    compilerName db " ruby.Value.ToUpper() uby Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Metaprogramming, Blocks, Mixins, Symbols Metaprogramming, Rails, Blocks", 13, 10, 0
