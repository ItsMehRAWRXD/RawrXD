; python_compiler_from_scratch - REAL Working Compiler
; Language:  python.Value.ToUpper() ython
; Features: Dynamic Types, Indentation, Classes, Modules Batteries Included, Dynamic, Popular
...
.data
    ...
    ; Compiler identity
    compilerName db " python.Value.ToUpper() ython Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Dynamic Types, Indentation, Classes, Modules Batteries Included, Dynamic, Popular", 13, 10, 0
