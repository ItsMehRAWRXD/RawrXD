; javascript_compiler_from_scratch - REAL Working Compiler
; Language:  javascript.Value.ToUpper() avascript
; Features: ES6+, Async/Await, Prototypes, Closures Web, Node.js, ES6+
...
.data
    ...
    ; Compiler identity
    compilerName db " javascript.Value.ToUpper() avascript Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] ES6+, Async/Await, Prototypes, Closures Web, Node.js, ES6+", 13, 10, 0
