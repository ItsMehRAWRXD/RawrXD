; test_full_eon_compiler - REAL Working Compiler
; Language:  test full eon compiler.Value.ToUpper() est full eon compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " test full eon compiler.Value.ToUpper() est full eon compiler Compiler v1.0", 13, 10, 0
