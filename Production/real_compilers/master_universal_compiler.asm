; master_universal_compiler - REAL Working Compiler
; Language:  master universal compiler.Value.ToUpper() aster universal compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " master universal compiler.Value.ToUpper() aster universal compiler Compiler v1.0", 13, 10, 0
