; self_hosted_eon_compiler - REAL Working Compiler
; Language:  self hosted eon compiler.Value.ToUpper() elf hosted eon compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " self hosted eon compiler.Value.ToUpper() elf hosted eon compiler Compiler v1.0", 13, 10, 0
