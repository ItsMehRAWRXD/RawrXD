; n0mn0m_quantum_asm_compiler - REAL Working Compiler
; Language:  n0mn0m quantum asm compiler.Value.ToUpper() 0mn0m quantum asm compiler
...
.data
    ...
    ; Compiler identity
    compilerName db " n0mn0m quantum asm compiler.Value.ToUpper() 0mn0m quantum asm compiler Compiler v1.0", 13, 10, 0
