; vyper_compiler_from_scratch - REAL Working Compiler
; Language:  vyper.Value.ToUpper() yper
; Features: Pythonic, Security, Ethereum
...
.data
    ...
    ; Compiler identity
    compilerName db " vyper.Value.ToUpper() yper Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Pythonic, Security, Ethereum", 13, 10, 0
