; go_compiler_from_scratch - REAL Working Compiler
; Language:  go.Value.ToUpper() o
...
.data
    ...
    ; Compiler identity
    compilerName db " go.Value.ToUpper() o Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Goroutines, Channels, Interfaces, Garbage Collection", 13, 10, 0
