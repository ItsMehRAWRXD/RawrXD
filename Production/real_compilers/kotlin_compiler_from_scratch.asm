; kotlin_compiler_from_scratch - REAL Working Compiler
; Language:  kotlin.Value.ToUpper() otlin
; Features: Null Safety, Coroutines, DSLs, Interop Android, JVM, Native, JS Android, JVM, Native
...
.data
    ...
    ; Compiler identity
    compilerName db " kotlin.Value.ToUpper() otlin Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] Null Safety, Coroutines, DSLs, Interop Android, JVM, Native, JS Android, JVM, Native", 13, 10, 0
