; java_compiler_from_scratch - REAL Working Compiler
; Language:  java.Value.ToUpper() ava
; Features: OOP, Generics, JVM Bytecode, Annotations
...
.data
    ...
    ; Compiler identity
    compilerName db " java.Value.ToUpper() ava Compiler v1.0", 13, 10, 0
    compilerNameLen equ $ - compilerName
    
    compilerReady db "[READY] Compiler initialized", 13, 10, 0
    compilerReadyLen equ $ - compilerReady
    
    compilerFeatures db "[FEATURES] OOP, Generics, JVM Bytecode, Annotations", 13, 10, 0
