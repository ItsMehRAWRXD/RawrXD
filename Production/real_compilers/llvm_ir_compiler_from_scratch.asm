; llvm_ir_compiler_from_scratch - REAL Working Compiler
; Language:  llvm ir.Value.ToUpper() lvm ir
...
.data
    ...
    ; Compiler identity
    compilerName db " llvm ir.Value.ToUpper() lvm ir Compiler v1.0", 13, 10, 0
