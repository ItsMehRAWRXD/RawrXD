; universal_compiler_runtime - REAL Working Compiler
; Language:  universal compiler runtime.Value.ToUpper() niversal compiler runtime
...
.data
    ...
    ; Compiler identity
    compilerName db " universal compiler runtime.Value.ToUpper() niversal compiler runtime Compiler v1.0", 13, 10, 0
