; python_compiler_from_scratch - Working Compiler
; Language: Python
; Features: Dynamic Types, Indentation, Classes, Modules
...
.data
    ...
    msg_features db "[FEATURES] Dynamic Types, Indentation, Classes, Modules", 13, 10
