; rust_compiler_from_scratch - Working Compiler
; Language: Rust
...
.data
    ...
    msg_banner db "Rust Compiler v1.0", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY] Compiler initialized", 13, 10
    msg_ready_len equ $ - msg_ready
    
    msg_features db "[FEATURES] Ownership, Borrowing, Lifetimes, Pattern Matching", 13, 10
