; c__compiler_from_scratch - Working Compiler
; Language: C++
; Features: Classes, Templates, STL, RAII, Smart Pointers
...
.data
    ...
    msg_features db "[FEATURES] Classes, Templates, STL, RAII, Smart Pointers", 13, 10
