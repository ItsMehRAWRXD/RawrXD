; javascript_compiler_from_scratch - Working Compiler
; Language: JavaScript
; Features: ES6+, Async/Await, Prototypes, Closures
...
.data
    ...
    msg_features db "[FEATURES] ES6+, Async/Await, Prototypes, Closures", 13, 10
