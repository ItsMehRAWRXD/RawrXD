; kotlin_compiler_from_scratch - Working Compiler
; Language: Kotlin
; Features: Null Safety, Coroutines, DSLs, Interop
...
.data
    ...
    msg_features db "[FEATURES] Null Safety, Coroutines, DSLs, Interop", 13, 10
