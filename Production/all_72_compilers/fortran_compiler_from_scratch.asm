; fortran_compiler_from_scratch - Production Compiler
; Source: fortran_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " fortran.Value.ToUpper() ortran Compiler v1.0", 13, 10
