; master_universal_compiler - Production Compiler
; Source: master_universal_compiler.asm
...
.data
    ...
    msg_banner db " master universal compiler.Value.ToUpper() aster universal compiler Compiler v1.0", 13, 10
