; uber_elegant_compiler - Production Compiler
; Source: uber_elegant_compiler.asm
...
.data
    ...
    msg_banner db " uber elegant compiler.Value.ToUpper() ber elegant compiler Compiler v1.0", 13, 10
