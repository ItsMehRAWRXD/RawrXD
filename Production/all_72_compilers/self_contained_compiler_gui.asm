; self_contained_compiler_gui - Production Compiler
; Source: self_contained_compiler_gui.asm
...
.data
    ...
    msg_banner db " self contained compiler gui.Value.ToUpper() elf contained compiler gui Compiler v1.0", 13, 10
