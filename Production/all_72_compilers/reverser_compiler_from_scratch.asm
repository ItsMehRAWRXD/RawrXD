; reverser_compiler_from_scratch - Production Compiler
; Source: reverser_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " reverser.Value.ToUpper() everser Compiler v1.0", 13, 10
