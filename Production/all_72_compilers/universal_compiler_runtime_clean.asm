; universal_compiler_runtime_clean - Production Compiler
; Source: universal_compiler_runtime_clean.asm
...
.data
    ...
    msg_banner db " universal compiler runtime clean.Value.ToUpper() niversal compiler runtime clean Compiler v1.0", 13, 10
