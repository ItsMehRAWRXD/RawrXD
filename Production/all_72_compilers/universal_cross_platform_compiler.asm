; universal_cross_platform_compiler - Production Compiler
; Source: universal_cross_platform_compiler.asm
...
.data
    ...
    msg_banner db " universal cross platform compiler.Value.ToUpper() niversal cross platform compiler Compiler v1.0", 13, 10
