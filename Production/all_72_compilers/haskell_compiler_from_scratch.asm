; haskell_compiler_from_scratch - Production Compiler
; Source: haskell_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " haskell.Value.ToUpper() askell Compiler v1.0", 13, 10
