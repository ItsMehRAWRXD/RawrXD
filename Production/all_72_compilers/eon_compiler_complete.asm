; eon_compiler_complete - Production Compiler
; Source: eon_compiler_complete.asm
...
.data
    ...
    msg_banner db " eon compiler complete.Value.ToUpper() on compiler complete Compiler v1.0", 13, 10
