; typescript_compiler_from_scratch - Production Compiler
; Source: typescript_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " typescript.Value.ToUpper() ypescript Compiler v1.0", 13, 10
