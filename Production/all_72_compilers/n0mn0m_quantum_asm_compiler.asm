; n0mn0m_quantum_asm_compiler - Production Compiler
; Source: n0mn0m_quantum_asm_compiler.asm
...
.data
    ...
    msg_banner db " n0mn0m quantum asm compiler.Value.ToUpper() 0mn0m quantum asm compiler Compiler v1.0", 13, 10
