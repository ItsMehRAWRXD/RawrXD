; crystal_compiler_from_scratch - Production Compiler
; Source: crystal_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " crystal.Value.ToUpper() rystal Compiler v1.0", 13, 10
