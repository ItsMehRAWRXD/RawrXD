; eon_kernel_compiler - Production Compiler
; Source: eon_kernel_compiler.asm
...
.data
    ...
    msg_banner db " eon kernel compiler.Value.ToUpper() on kernel compiler Compiler v1.0", 13, 10
