; integrated_eon_compiler - Production Compiler
; Source: integrated_eon_compiler.asm
...
.data
    ...
    msg_banner db " integrated eon compiler.Value.ToUpper() ntegrated eon compiler Compiler v1.0", 13, 10
