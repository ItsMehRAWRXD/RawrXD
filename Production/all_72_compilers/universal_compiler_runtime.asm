; universal_compiler_runtime - Production Compiler
; Source: universal_compiler_runtime.asm
...
.data
    ...
    msg_banner db " universal compiler runtime.Value.ToUpper() niversal compiler runtime Compiler v1.0", 13, 10
