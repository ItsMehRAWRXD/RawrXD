; test_full_eon_compiler - Production Compiler
; Source: test_full_eon_compiler.asm
...
.data
    ...
    msg_banner db " test full eon compiler.Value.ToUpper() est full eon compiler Compiler v1.0", 13, 10
