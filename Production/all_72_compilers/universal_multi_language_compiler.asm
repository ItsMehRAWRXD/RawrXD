; universal_multi_language_compiler - Production Compiler
; Source: universal_multi_language_compiler.asm
...
.data
    ...
    msg_banner db " universal multi language compiler.Value.ToUpper() niversal multi language compiler Compiler v1.0", 13, 10
