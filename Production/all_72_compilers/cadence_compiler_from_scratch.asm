; cadence_compiler_from_scratch - Production Compiler
; Source: cadence_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " cadence.Value.ToUpper() adence Compiler v1.0", 13, 10
