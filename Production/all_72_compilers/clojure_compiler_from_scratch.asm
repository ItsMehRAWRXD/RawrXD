; clojure_compiler_from_scratch - Production Compiler
; Source: clojure_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " clojure.Value.ToUpper() lojure Compiler v1.0", 13, 10
