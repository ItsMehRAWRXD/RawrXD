; solidity_compiler_from_scratch - Production Compiler
; Source: solidity_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " solidity.Value.ToUpper() olidity Compiler v1.0", 13, 10
