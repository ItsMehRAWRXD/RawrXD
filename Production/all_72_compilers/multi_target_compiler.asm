; multi_target_compiler - Production Compiler
; Source: multi_target_compiler.asm
...
.data
    ...
    msg_banner db " multi target compiler.Value.ToUpper() ulti target compiler Compiler v1.0", 13, 10
