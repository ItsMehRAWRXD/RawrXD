; test_self_hosted_compiler - Production Compiler
; Source: test_self_hosted_compiler.asm
...
.data
    ...
    msg_banner db " test self hosted compiler.Value.ToUpper() est self hosted compiler Compiler v1.0", 13, 10
