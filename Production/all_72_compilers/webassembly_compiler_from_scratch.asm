; webassembly_compiler_from_scratch - Production Compiler
; Source: webassembly_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " webassembly.Value.ToUpper() ebassembly Compiler v1.0", 13, 10
