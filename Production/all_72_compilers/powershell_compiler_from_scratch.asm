; powershell_compiler_from_scratch - Production Compiler
; Source: powershell_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " powershell.Value.ToUpper() owershell Compiler v1.0", 13, 10
