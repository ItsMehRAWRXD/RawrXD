; self_hosted_eon_compiler - Production Compiler
; Source: self_hosted_eon_compiler.asm
...
.data
    ...
    msg_banner db " self hosted eon compiler.Value.ToUpper() elf hosted eon compiler Compiler v1.0", 13, 10
