; llvm_ir_compiler_from_scratch - Production Compiler
; Source: llvm_ir_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " llvm ir.Value.ToUpper() lvm ir Compiler v1.0", 13, 10
