; assembly_compiler_from_scratch - Production Compiler
; Source: assembly_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " assembly.Value.ToUpper() ssembly Compiler v1.0", 13, 10
