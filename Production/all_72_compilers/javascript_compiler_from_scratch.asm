; javascript_compiler_from_scratch - Production Compiler
; Source: javascript_compiler_from_scratch.asm
...
.data
    ...
    msg_banner db " javascript.Value.ToUpper() avascript Compiler v1.0", 13, 10
