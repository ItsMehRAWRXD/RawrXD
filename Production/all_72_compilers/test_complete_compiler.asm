; test_complete_compiler - Production Compiler
; Source: test_complete_compiler.asm
...
.data
    ...
    msg_banner db " test complete compiler.Value.ToUpper() est complete compiler Compiler v1.0", 13, 10
