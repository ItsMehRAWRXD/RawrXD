; n0mn0m_cross_platform_compiler - Production Compiler
; Source: n0mn0m_cross_platform_compiler.asm
...
.data
    ...
    msg_banner db " n0mn0m cross platform compiler.Value.ToUpper() 0mn0m cross platform compiler Compiler v1.0", 13, 10
