; cross_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " cross compiler.Value.ToUpper() ross compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  cross compiler.Value.ToUpper() ross compiler initialized", 13, 10
