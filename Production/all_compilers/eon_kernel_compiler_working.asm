; eon_kernel_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " eon kernel compiler.Value.ToUpper() on kernel compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  eon kernel compiler.Value.ToUpper() on kernel compiler initialized", 13, 10
