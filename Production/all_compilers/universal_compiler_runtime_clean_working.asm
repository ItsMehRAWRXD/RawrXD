; universal_compiler_runtime_clean - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " universal compiler runtime clean.Value.ToUpper() niversal compiler runtime clean v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  universal compiler runtime clean.Value.ToUpper() niversal compiler runtime clean initialized", 13, 10
