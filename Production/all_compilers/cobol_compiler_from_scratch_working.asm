; cobol_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " cobol.Value.ToUpper() obol v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  cobol.Value.ToUpper() obol initialized", 13, 10
