; self_contained_compiler_gui - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " self contained compiler gui.Value.ToUpper() elf contained compiler gui v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  self contained compiler gui.Value.ToUpper() elf contained compiler gui initialized", 13, 10
