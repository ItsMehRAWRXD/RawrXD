; self_hosted_eon_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " self hosted eon compiler.Value.ToUpper() elf hosted eon compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  self hosted eon compiler.Value.ToUpper() elf hosted eon compiler initialized", 13, 10
