; perl_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " perl.Value.ToUpper() erl v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  perl.Value.ToUpper() erl initialized", 13, 10
