; move_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " move.Value.ToUpper() ove v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  move.Value.ToUpper() ove initialized", 13, 10
