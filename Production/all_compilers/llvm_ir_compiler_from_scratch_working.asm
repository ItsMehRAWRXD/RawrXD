; llvm_ir_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " llvm ir.Value.ToUpper() lvm ir v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  llvm ir.Value.ToUpper() lvm ir initialized", 13, 10
