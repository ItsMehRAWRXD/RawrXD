; eon_compiler_complete - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " eon compiler complete.Value.ToUpper() on compiler complete v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  eon compiler complete.Value.ToUpper() on compiler complete initialized", 13, 10
