; universal_compiler_runtime - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " universal compiler runtime.Value.ToUpper() niversal compiler runtime v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  universal compiler runtime.Value.ToUpper() niversal compiler runtime initialized", 13, 10
