; full_eon_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " full eon compiler.Value.ToUpper() ull eon compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  full eon compiler.Value.ToUpper() ull eon compiler initialized", 13, 10
