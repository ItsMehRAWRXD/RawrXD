; scala_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " scala.Value.ToUpper() cala v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  scala.Value.ToUpper() cala initialized", 13, 10
