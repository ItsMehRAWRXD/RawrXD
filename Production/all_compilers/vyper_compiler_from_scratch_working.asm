; vyper_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " vyper.Value.ToUpper() yper v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  vyper.Value.ToUpper() yper initialized", 13, 10
