; reverser_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " reverser compiler.Value.ToUpper() everser compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  reverser compiler.Value.ToUpper() everser compiler initialized", 13, 10
