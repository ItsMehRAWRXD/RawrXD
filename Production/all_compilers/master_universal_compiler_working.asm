; master_universal_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " master universal compiler.Value.ToUpper() aster universal compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  master universal compiler.Value.ToUpper() aster universal compiler initialized", 13, 10
