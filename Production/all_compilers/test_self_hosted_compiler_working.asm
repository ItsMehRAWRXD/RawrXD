; test_self_hosted_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " test self hosted compiler.Value.ToUpper() est self hosted compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  test self hosted compiler.Value.ToUpper() est self hosted compiler initialized", 13, 10
