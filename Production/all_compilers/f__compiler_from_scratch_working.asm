; f__compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " f .Value.ToUpper()   v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  f .Value.ToUpper()   initialized", 13, 10
