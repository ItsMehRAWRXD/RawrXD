; eon_compiler_main - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " eon compiler main.Value.ToUpper() on compiler main v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  eon compiler main.Value.ToUpper() on compiler main initialized", 13, 10
