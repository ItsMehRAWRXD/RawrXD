; cadence_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " cadence.Value.ToUpper() adence v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  cadence.Value.ToUpper() adence initialized", 13, 10
