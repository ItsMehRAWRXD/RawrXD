; test_complete_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " test complete compiler.Value.ToUpper() est complete compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  test complete compiler.Value.ToUpper() est complete compiler initialized", 13, 10
