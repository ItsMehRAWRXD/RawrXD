; integrated_eon_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " integrated eon compiler.Value.ToUpper() ntegrated eon compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  integrated eon compiler.Value.ToUpper() ntegrated eon compiler initialized", 13, 10
