; carbon_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " carbon.Value.ToUpper() arbon v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  carbon.Value.ToUpper() arbon initialized", 13, 10
