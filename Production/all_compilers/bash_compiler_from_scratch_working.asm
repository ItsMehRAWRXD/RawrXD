; bash_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " bash.Value.ToUpper() ash v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  bash.Value.ToUpper() ash initialized", 13, 10
