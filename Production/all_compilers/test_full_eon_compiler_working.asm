; test_full_eon_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " test full eon compiler.Value.ToUpper() est full eon compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  test full eon compiler.Value.ToUpper() est full eon compiler initialized", 13, 10
