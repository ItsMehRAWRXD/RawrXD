; vb_net_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " vb net.Value.ToUpper() b net v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  vb net.Value.ToUpper() b net initialized", 13, 10
