; matlab_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " matlab.Value.ToUpper() atlab v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  matlab.Value.ToUpper() atlab initialized", 13, 10
