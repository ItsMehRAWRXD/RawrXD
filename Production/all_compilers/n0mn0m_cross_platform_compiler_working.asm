; n0mn0m_cross_platform_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " n0mn0m cross platform compiler.Value.ToUpper() 0mn0m cross platform compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  n0mn0m cross platform compiler.Value.ToUpper() 0mn0m cross platform compiler initialized", 13, 10
