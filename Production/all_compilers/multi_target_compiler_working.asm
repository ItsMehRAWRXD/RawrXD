; multi_target_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " multi target compiler.Value.ToUpper() ulti target compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  multi target compiler.Value.ToUpper() ulti target compiler initialized", 13, 10
