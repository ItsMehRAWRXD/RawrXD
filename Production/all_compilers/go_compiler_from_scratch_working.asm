; go_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " go.Value.ToUpper() o v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  go.Value.ToUpper() o initialized", 13, 10
