; uber_elegant_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " uber elegant compiler.Value.ToUpper() ber elegant compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  uber elegant compiler.Value.ToUpper() ber elegant compiler initialized", 13, 10
