; zig_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " zig.Value.ToUpper() ig v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  zig.Value.ToUpper() ig initialized", 13, 10
