; universal_multi_language_compiler - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " universal multi language compiler.Value.ToUpper() niversal multi language compiler v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  universal multi language compiler.Value.ToUpper() niversal multi language compiler initialized", 13, 10
