; ada_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " ada.Value.ToUpper() da v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  ada.Value.ToUpper() da initialized", 13, 10
