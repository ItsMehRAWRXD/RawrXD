; delphi_compiler_from_scratch - Working Compiler with Windows API
...
.data
    ...
    msg_banner db " delphi.Value.ToUpper() elphi v1.0 - Production Ready", 13, 10
    msg_banner_len equ $ - msg_banner
    
    msg_ready db "[READY]  delphi.Value.ToUpper() elphi initialized", 13, 10
