...
set "INCLUDE=%VCINCLUDE%;%SDK%\Include\%SDKVER%\shared;%SDK%\Include\%SDKVER%\um;%SDK%\Include\%SDKVER%\ucrt"
...
echo [19/18] Assembling Math Primitives...
%ML64% /c /nologo /Fo%OBJ%\Sovereign_Math_Primitives.obj %SRC%\Sovereign_Math_Primitives.asm
...
%LINK% /SUBSYSTEM:CONSOLE /NODEFAULTLIB /ENTRY:main /OUT:%BIN%\Sovereign_Platinum_Engine.exe ^
  ...
  %OBJ%\Sovereign_Math_Primitives.obj ^
