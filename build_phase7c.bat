@echo off
REM =============================================================================
REM RawRamXD Phase 7C Build Script
...
set CXX=cl.exe
set CXXFLAGS=/std:c++17 /EHsc /W4 /O2 /arch:AVX2 /D_CRT_SECURE_NO_WARNINGS
...
%CXX% %CXXFLAGS% %INCLUDES% /Fo"%BUILD_DIR%\\" /Fe"%BUILD_DIR%\%OUTPUT_NAME%.exe" %SOURCES% %LIBS%
