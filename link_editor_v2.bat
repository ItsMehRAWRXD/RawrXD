...
"%LINK_EXE%" /DLL /DEBUG /INCREMENTAL:NO /ENTRY:DllMain /LIBPATH:"%LIB1%" /LIBPATH:"%LIB2%" /LIBPATH:"%LIB3%" /OUT:d:\rawrxd\build-editor-pipeline\bin\editor_pipeline.dll d:\rawrxd\build-editor-pipeline\input_handler.obj d:\rawrxd\build-editor-pipeline\wndproc_input_bridge.obj d:\rawrxd\build-editor-pipeline\editor.obj d:\rawrxd\build-editor-pipeline\memory.obj user32.lib kernel32.lib gdi32.lib
