...
struct AbsoluteTruthLoopMetrics {
    ...
    AbsoluteTruthLoopMetrics() = default;
};

// Main loop class
class AbsoluteTruthLoop {
public:
    // Initialization
    static bool Init(const AbsoluteTruthLoopConfig& config = AbsoluteTruthLoopConfig());
    ...
    // Configuration
    static void SetConfig(const AbsoluteTruthLoopConfig& config);
    static AbsoluteTruthLoopConfig GetConfig();
    
    // Metrics
    static AbsoluteTruthLoopMetrics GetMetrics();
...
private:
    ...
    static AbsoluteTruthLoopConfig s_config;
    static AbsoluteTruthLoopMetrics s_metrics;
