...
struct EternalRadianceLoopMetrics {
    ...
    EternalRadianceLoopMetrics() = default;
};

// Main loop class
class EternalRadianceLoop {
public:
    // Initialization
    static bool Init(const EternalRadianceLoopConfig& config = EternalRadianceLoopConfig());
    ...
    // Configuration
    static void SetConfig(const EternalRadianceLoopConfig& config);
    static EternalRadianceLoopConfig GetConfig();
    
    // Metrics
    static EternalRadianceLoopMetrics GetMetrics();
...
private:
    ...
    static EternalRadianceLoopConfig s_config;
    static EternalRadianceLoopMetrics s_metrics;
