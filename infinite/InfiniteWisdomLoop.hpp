...
struct InfiniteWisdomLoopMetrics {
    ...
    InfiniteWisdomLoopMetrics() = default;
};

// Main loop class
class InfiniteWisdomLoop {
public:
    // Initialization
    static bool Init(const InfiniteWisdomLoopConfig& config = InfiniteWisdomLoopConfig());
    ...
    // Configuration
    static void SetConfig(const InfiniteWisdomLoopConfig& config);
    static InfiniteWisdomLoopConfig GetConfig();
    
    // Metrics
    static InfiniteWisdomLoopMetrics GetMetrics();
...
private:
    ...
    static InfiniteWisdomLoopConfig s_config;
    static InfiniteWisdomLoopMetrics s_metrics;
