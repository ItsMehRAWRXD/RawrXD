...
struct InfinitePerfectionMetrics {
    double infinitePerfectionCount = 0;
    double nodeCount = 0;
    ...
    double averageInfinity = 0.0;
    double averagePerfection = 0.0;
    double averageAbsoluteness = 0.0;
    ...
    double infiniteResonance = 0.0;
    double perfectionResonance = 0.0;
    double absoluteResonance = 0.0;
    ...
    double absolutenessResonance = 0.0;
};

class InfinitePerfectionLoop {
public:
    static InfinitePerfectionLoop& GetInstance();
    ...
    InfinitePerfectionMetrics GetMetrics() const;
    void ResetMetrics();
    ...
    void TriggerInfiniteResonance();
    void TriggerPerfectionResonance();
...
private:
    InfinitePerfectionLoop() = default;
    ~InfinitePerfectionLoop() { Stop(); }
    ...
    std::atomic<double> infiniteResonance_{0.0};
    std::atomic<double> perfectionResonance_{0.0};
    std::atomic<double> absoluteResonance_{0.0};
    ...
    std::atomic<double> absolutenessResonance_{0.0};
    ...
    InfinitePerfectionMetrics metrics_;
