...
struct InfiniteLightLoopMetrics {
    ...
    InfiniteLightLoopMetrics() = default;
};

// Main loop class
class InfiniteLightLoop {
public:
    // Initialization
    static bool Init(const InfiniteLightLoopConfig& config = InfiniteLightLoopConfig());
    ...
    // Configuration
    static void SetConfig(const InfiniteLightLoopConfig& config);
    static InfiniteLightLoopConfig GetConfig();
    
    // Metrics
    static InfiniteLightLoopMetrics GetMetrics();
...
private:
    ...
    static InfiniteLightLoopConfig s_config;
    static InfiniteLightLoopMetrics s_metrics;
