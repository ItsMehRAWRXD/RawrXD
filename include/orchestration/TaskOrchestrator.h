...
public:
    ...
    // Additional private helper methods for implementation
...
private:
    ...
    QHash<QString, QPointer<QTextEdit>> m_taskContentAreas;
    QHash<QString, QPointer<QProgressBar>> m_taskProgressBars;
