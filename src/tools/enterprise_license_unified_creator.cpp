...
static const V2WiringStatus g_v2Wiring[] = {
    ...
    { FeatureID::ByteLevelHotpatching,  true, true, true, true,  true, true, false,1, "byte_level_hotpatcher.cpp - license gate" },
    { FeatureID::ServerHotpatching,     true, true, true, true,  true, false,false,1, "gguf_server_hotpatch.cpp - license gate" },
    { FeatureID::UnifiedHotpatchManager,true, true, true, true,  true, true, false,1, "unified_hotpatch_manager.cpp - license gate" },
    ...
    { FeatureID::TokenStreaming,         true, true, true, true,  true, true, false,1, "streaming_engine.cpp - license gate" },
    { FeatureID::InferenceStatistics,   true, true, true, true,  true, true, false,1, "ai_metrics.cpp - license gate" },
    { FeatureID::KVCacheManagement,     true, true, true, true,  true, false,false,1, "cpu_inference_engine.cpp - license gate" },
    ...
    { FeatureID::AgenticFailureDetect,  true, true, true, true,  true, true, false,1, "agentic_failure_detector.cpp - license gate" },
    { FeatureID::AgenticPuppeteer,      true, true, true, true,  true, true, false,1, "agentic_puppeteer.cpp — ENFORCE_FEATURE wired" },
    { FeatureID::AgenticSelfCorrection, true, true, true, false, true, true, false,1, "agentic_self_corrector.cpp" },
    { FeatureID::ProxyHotpatching,      true, true, true, true,  true, true, false,1, "proxy_hotpatcher.cpp - license gate" },
    { FeatureID::ServerSidePatching,    true, true, true, true,  true, false,false,1, "gguf_server_hotpatch.cpp - license gate" },
    ...
    // ── Sovereign (53–60) — All Planned ──
    { FeatureID::AirGappedDeploy,       false,false,false,false,false,false,false,3, "Gov-only — not implemented" },
    { FeatureID::HSMIntegration,        false,false,false,false,false,false,false,3, "Needs HSM SDK" },
    { FeatureID::FIPS140_2Compliance,   false,false,false,false,false,false,false,3, "Needs certified crypto" },
    { FeatureID::CustomSecurityPolicies,false,false,false,false,false,false,false,3, "Not implemented" },
    { FeatureID::SovereignKeyMgmt,      false,false,false,false,false,false,false,3, "Not implemented" },
    { FeatureID::ClassifiedNetwork,     false,false,false,false,false,false,false,3, "Not implemented" },
    { FeatureID::TamperDetection,       true, true, true, false, false,false,false,2, "License_Shield.asm" },
    { FeatureID::SecureBootChain,       false,false,false,false,false,false,false,3, "Not implemented" },
};
...
static const PhaseInfo g_phases[] = {
    ...
    { 2, "Enforcement Gates & Runtime Flags",
      ...
      "IN PROGRESS — 6/10 tasks complete" },
