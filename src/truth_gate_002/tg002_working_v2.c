/* tg002_working_v2.c - Working GGUF parser */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
...
/* Skip metadata and return position of tensor section */
static size_t skip_metadata_v2(uint8_t* data, uint64_t count) {
    size_t pos = 24;
    ...
    for (uint64_t i = 0; i < count; i++) {
        ...
        switch (val_type) {
            case 0: case 1: case 10: pos += 1; break; /* uint8, int8, bool */
            case 2: case 3: pos += 2; break; /* uint16, int16 */
            case 4: case 5: case 6: pos += 4; break; /* uint32, int32, float32 */
            case 7: case 8: case 9: pos += 8; break; /* uint64, int64, float64 */
            case 11: { /* string */
            ...
            case 12: { /* array */
                ...
                pos += 8;
                size_t elem_size = 1;
                if (arr_type >= 4 && arr_type <= 6) elem_size = 4;
                else if (arr_type >= 7 && arr_type <= 9) elem_size = 8;
...
int gguf_open(const char* path, gguf_context_t* ctx) {
    ...
    uint64_t metadata_count = get_u64(ctx->data + 16);
    ...
    size_t pos = skip_metadata_v2(ctx->data, metadata_count);
    printf("Tensors at offset %zu\n", pos);
...
int main(int argc, char* argv[]) {
    printf("========================================\n");
    printf("Truth Gate 002 - WORKING V2\n");
    printf("========================================\n\n");
