...
@loop8:
    ...
    vhaddps xmm0, xmm0, xmm0     ; pairwise sum
...
Deep2_SwiGLU_AVX2 PROC FRAME
    ...
    ; Load constants
    vbroadcastss ymm6, dword ptr [__minus_one]    ; -1.0
    vbroadcastss ymm7, dword ptr [__one]         ; 1.0
...
@swiglu_loop8:
    ...
    vexpp2ps ymm3, ymm2          ; exp(-x) approximation
    vaddps ymm3, ymm3, ymm7      ; 1 + exp(-x)
    vdivps ymm4, ymm7, ymm3      ; sigmoid(x)
...
@swiglu_loop1:
    ...
    vdivss xmm4, [__one], xmm3   ; 1 / (1 + exp(-x))
...
Deep2_RMSNorm_AVX2 PROC FRAME
    ...
    mov rdi, rdx        ; out
    mov rbx, r8         ; n
    vmovss xmm4, xmm3   ; eps from stack
