; ============================================================================
; sovereign_fp8_gemv.asm - FP8 GEMV Kernel (AVX2)
; 8-bit float matrix-vector multiply (E4M3 format)
; ============================================================================
...
ColLoop:
    ...
    vmulss xmm1, xmm1, dword ptr [ScaleFactor]
