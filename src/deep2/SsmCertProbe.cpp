...
const char* stageName(Stage s) {
    switch (s) {
    case Stage::Alpha: return "SSM_ALPHA";
    case Stage::Beta: return "SSM_BETA";
    case Stage::Conv: return "SSM_CONV";
    case Stage::StatePre: return "SSM_STATE_PRE";
    case Stage::StatePost: return "SSM_STATE_POST";
    case Stage::Norm: return "SSM_NORM";
    case Stage::Out: return "SSM_OUT";
    case Stage::SeqStep: return "SSM_SEQ_STEP";
    }
    return "UNKNOWN";
}
