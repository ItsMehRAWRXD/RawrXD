//============================================================================
// nevm_golden_output.cpp
// RawrXD N-EVM - Golden Output Implementation
//============================================================================
...
bool GoldenOutput::Compare(const std::vector<int32_t>& actual) const {
...
Json::Value GoldenOutput::ToJSON() const {
    Json::Value gold;
...
GoldenOutput GoldenOutput::FromJSON(const Json::Value& json) {
    GoldenOutput gold;
...
GoldenOutput GoldenOutput::LoadFromBinary(const std::string& prompt_path,
...
//============================================================================
// Golden Output Tester
//============================================================================

void GoldenOutputTester::RunTest(const std::string& name, 
...
bool GoldenOutputTester::AllPassed() const {
...
void GoldenOutputTester::PrintReport() const {
...
Json::Value GoldenOutputTester::ToJSON() const {
    Json::Value report;
    for (const auto& r : results) {
        Json::Value test;
