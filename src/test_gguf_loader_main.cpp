// Test harness for GGUF loader architecture detection
// Build: ninja Test-GGUF-Loader
// Run: .\test_gguf_loader.exe <model.gguf>
...
int main(int argc, char** argv) {
    ...
    // Debug: Print all KV pairs
    std::cerr << "\n========================================" << std::endl;
    std::cerr << "ALL KV PAIRS" << std::endl;
    std::cerr << "========================================" << std::endl;
    ...
    // Validation for Qwen3.5-40B (architecture_type is now uint32_t: 1=llama, 2=qwen2, 3=phi3, 4=gemma)
