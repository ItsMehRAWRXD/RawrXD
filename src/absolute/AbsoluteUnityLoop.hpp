...
struct AbsoluteUnityMetrics {
    double absoluteUnityCount = 0;
    double nodeCount = 0;
...
class AbsoluteUnityLoop {
public:
    static AbsoluteUnityLoop& GetInstance();
    ...
    AbsoluteUnityMetrics GetMetrics() const;
    void ResetMetrics();
...
private:
    AbsoluteUnityLoop() = default;
    ~AbsoluteUnityLoop() { Stop(); }
