...
PUBLIC KVCacheAttention_RDNA3_BinSize
...
PUBLIC TileStreamer_RDNA3_BinSize
...
;------------------------------------------------------------------------------
PUBLIC Get_All_Kernel_Binaries
Get_All_Kernel_Binaries PROC
    push    rbx
