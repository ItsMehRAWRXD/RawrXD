...
void DrawingContext::transform(const void4x4& matrix) {
...
FontMetrics DrawingContext::measureFont(const std::string& fontFamily, float fontSize) {
    FontMetrics metrics;
...
Rect DrawingContext::measureText(const std::string& text, const std::string& fontFamily, float fontSize) {
...
Label::Label(const Rect& bounds, const std::string& text) : Component(bounds), m_text(text) {}
