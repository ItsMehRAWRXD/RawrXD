...
@compact_loop:
    ...
    mov dword ptr [r15 + GpuTransferOp.OpType], 2 ; COPY
    mov r8, qword ptr [rdx + VramBlock.VOffset]
    mov qword ptr [r15 + GpuTransferOp.SrcHostPtr], r8  ; Use SrcHostPtr as SrcOffset for Copy
    mov qword ptr [r15 + GpuTransferOp.DstVramOffset], r13
    mov r8, qword ptr [rdx + VramBlock.VSize]
    mov qword ptr [r15 + GpuTransferOp.OpSize], r8
