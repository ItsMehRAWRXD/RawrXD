;============================================================================
; DumpBin Replacement Final v6.0
; Universal Binary Analyzer - Complete Implementation
;============================================================================
...
@@section_loop:
    ...
    invoke wsprintf, addr szBuffer, addr szSectionEntry, \
        dwSectionAddr, dword ptr [dwSectionAddr+8], dword ptr [dwSectionAddr+12], dword ptr [dwSectionAddr+16]
    invoke DisplayMessage, addr szBuffer
...
@@print_ascii:
    mov byte ptr [szBuffer+j], bAscii
