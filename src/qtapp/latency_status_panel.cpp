...
{
    // Flash the ping label when updated with border highlight
    if (m_pingLabel) {
        m_pingLabel->setStyleSheet("font-weight: bold; color: #0f0; background: #1a1a1a; padding: 4px; border-radius: 3px; border: 2px solid #0f0;");
    }
}
