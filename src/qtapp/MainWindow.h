...
private: /* ---------------  original members  --------------- */
    ...
    QLabel* m_memoryLabel{};      // Real-time RAM monitor in status bar
...
private: /* ---------------  new IDE members  --------------- */
    ...
    QTreeWidget* m_explorerView{};
    QSet<QString> m_knownRootPaths_{};
    QTimer* m_driveRefreshTimer{};
    bool m_refreshingDrives_{false};
