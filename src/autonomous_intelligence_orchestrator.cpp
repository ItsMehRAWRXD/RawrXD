...
void AutonomousIntelligenceOrchestrator::generateImplementation(const std::string& requirement) {
    ...
    if (m_modelRouter && m_modelRouter->isModelAvailable("local")) {
        ...
        prompt += "Requirements:\n";
        prompt += "- Use modern C++17 features\n";
        prompt += "- Include proper error handling\n";
        prompt += "- Add comments explaining the logic\n";
    ...
    if (generatedCode.empty()) {
        // Fallback: generate a template based on the requirement
        generatedCode = "// Auto-generated implementation for: " + requirement + "\n";
        generatedCode += "// Generated by RawrXD Autonomous Intelligence\n\n";
        generatedCode += "#include <string>\n";
        generatedCode += "#include <vector>\n";
        generatedCode += "#include <memory>\n\n";
        generatedCode += "namespace RawrXD {\n\n";
        generatedCode += "// TODO: Implement " + requirement + "\n";
        generatedCode += "// This is a generated template - review and implement the actual logic\n\n";
        generatedCode += "} // namespace RawrXD\n";
    }
    
    if (onNotification) {
        onNotification("Status", "Implementation generated for: " + requirement);
    }
}
