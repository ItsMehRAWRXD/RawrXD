<<<<<<< HEAD
;============================================================================
; DumpBin Complete v6.0
; Universal Binary Analyzer - MASM32 Compatible Implementation
;============================================================================
...
szWelcome               db "DumpBin Complete v", CLI_VERSION, 0Dh, 0Ah
...
@@section_loop:
    ...
    invoke wsprintf, addr szBuffer, addr szSectionEntry, dwSectionAddr, dwVA, dwSize, dwRaw
    invoke DisplayMessage, addr szBuffer
