...
extern "C"
{
    ...
    // rawrxd_subsystem_api.cpp mode symbols - provided by rawrxd_subsys_modes_*.cpp
    // NOT DEFINED HERE to avoid duplicate symbol errors
    
    // SO_* symbols (Sovereign subsystem) - provided by streaming_orchestrator.cpp
    // NOT DEFINED HERE to avoid duplicate symbol errors
    ...
    // asm_perf_* symbols (referenced by agentic_deep_thinking_engine.cpp)
    ...
    // asm_apply_memory_patch defined in minimal_gold_main.cpp
