...
// ============================================================================
// NOTE: buildCommandRegistry(), showCommandPalette(), hideCommandPalette(),
// filterCommandPalette(), executeCommandFromPalette(), CommandPaletteProc(),
// and CommandPaletteInputProc() are defined in Win32IDE.cpp to avoid
