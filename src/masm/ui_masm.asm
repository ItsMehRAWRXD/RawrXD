...
cmd_copy_done:
    ; Add timestamp and command to terminal output
    ...
    ; In a full implementation, would spawn cmd.exe and capture output
...
handle_run_command PROC
    ...
    ; In production, would spawn build process
...
navigate_problem_panel PROC
    ...
    ; Get error from problems array (stored in a global buffer)
    ; In production, would have proper error structure array
...
problem_digit_count:
    ...
    inc rcx
    test rax, rax
    jnz problem_digit_count
    
    ; Now output digits (would need better conversion)
    ; For now, just put placeholder
    mov BYTE PTR [rdi], '0'
    inc rdi
