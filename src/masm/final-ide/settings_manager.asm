@masm_settings_init EQU 1
@masm_settings_load EQU 1
@masm_settings_save EQU 1
@masm_settings_get_int EQU 1
@masm_settings_set_int EQU 1
@masm_settings_get_string EQU 1
@masm_settings_set_string EQU 1
@masm_settings_get_bool EQU 1
@masm_settings_set_bool EQU 1
@masm_settings_get_float EQU 1
@masm_settings_set_float EQU 1
@masm_settings_reset_to_defaults EQU 1
;==============================================================================
...
masm_settings_load PROC
    ...
    mov rcx, HKEY_CURRENT_USER      ; hKey = HKEY_CURRENT_USER
