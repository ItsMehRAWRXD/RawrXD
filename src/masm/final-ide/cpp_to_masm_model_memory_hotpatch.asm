...
@@patch_disabled:
    ...
    pop rsi
    pop memory
    pop rbx_hotpatch_apply_patch ENDP
...
@@capacity_exceeded:
    ...
    pop rsi
    pop memory
    pop rbx_hotpatch_add_patch ENDP
...
@@capacity_exceeded:
    ...
    pop rsi
    pop memory
    pop rbx_hotpatch_add_region ENDP
