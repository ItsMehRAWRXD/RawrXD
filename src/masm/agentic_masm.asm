...
not_list_dir_local:
    ...
    mov byte ptr [rax], 'C'
    mov byte ptr [rax + 1], 'o'
    mov byte ptr [rax + 2], 'm'
    mov byte ptr [rax + 3], 'm'
    mov byte ptr [rax + 4], 'a'
    mov byte ptr [rax + 5], 'n'
    mov byte ptr [rax + 6], 'd'
    mov byte ptr [rax + 7], ' '
    mov byte ptr [rax + 8], 'n'
    mov byte ptr [rax + 9], 'o'
    mov byte ptr [rax + 10], 't'
    mov byte ptr [rax + 11], ' '
    mov byte ptr [rax + 12], 'f'
    mov byte ptr [rax + 13], 'o'
    mov byte ptr [rax + 14], 'u'
