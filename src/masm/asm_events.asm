...
; Export all public event functions
PUBLIC asm_event_loop_create, asm_event_loop_destroy
PUBLIC asm_event_loop_register_signal, asm_event_loop_emit
PUBLIC asm_event_loop_process_one, asm_event_loop_process_all
PUBLIC asm_event_stats, asm_event_loop_stats
...
asm_event_loop_emit PROC
    ...
    ; Timestamp (simplified: use qword counter)
    lock add [g_total_events], 1
    mov rax, [g_total_events]
    mov [r8 + 40], rax      ; Timestamp
