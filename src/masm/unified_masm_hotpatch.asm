...
PATCH_MAGIC         equ 0x50544348h        ; 'PTCH'
PATCH_LAYER_MEMORY  equ 0h
PATCH_LAYER_BYTE    equ 1h
PATCH_LAYER_SERVER  equ 2h

; Memory protection flags
PAGE_READWRITE      equ 0x04h
PAGE_EXECUTE_READWRITE equ 0x40h
...
.data?
    ...
    patch_count         DWORD 0
    stat_patches_applied QWORD 0
    stat_bytes_written  QWORD 0
...
hpatch_apply_memory PROC
    ...
    lea r9, [rsp + 24]                      ; lpflOldProtect (shadow area)
    call VirtualProtect
    test eax, eax
