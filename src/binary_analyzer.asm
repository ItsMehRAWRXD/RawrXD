...
szWelcome               db "Binary Analyzer v", CLI_VERSION, 0Dh, 0Ah
                        db "========================================", 0Dh, 0Ah, 0Dh, 0Ah, 0
szMenu                  db "[1] Analyze file", 0Dh, 0Ah
...
AnalyzePE PROC
    ...
    ; Get PE offset
    mov eax, dword ptr [pDosHeader+60]  ; e_lfanew
    add eax, pDosHeader
    mov pPeHeader, eax
