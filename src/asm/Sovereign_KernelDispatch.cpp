...
int Sovereign_InitKernelTable(Sovereign_KernelTable* table) {
    ...
    // Load Phase 7B Intrinsics Optimized Kernels (if available)
    // These may not be available in all builds - use q4_0_q8_0_matmul as fallback
    table->q4q8_matmul_intrinsics = nullptr;  // Sovereign_Q4Q8_MatMul_Intrinsics not always available
    table->flash_attention_v2_intrinsics = nullptr;  // Sovereign_FlashAttentionV2_Intrinsics not always available
