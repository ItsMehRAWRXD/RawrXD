...
; ============================================================
RawrXD_RawrXD_Kernel_Prefetch PROC PRIVATE FRAME
    push rsi
    .PUSHREG RSI
    push rdi
    .PUSHREG RDI
...
@@done:
    ...
    pop rsi
    ret
RawrXD_RawrXD_Kernel_Prefetch ENDP
...
; ============================================================
RawrXD_KERNEL_TYPE_COPY PROC PRIVATE FRAME
    push rbx
    .PUSHREG RBX
    push rsi
    .PUSHREG RSI
...
@@do_prefetch:
    ...
    call RawrXD_KERNEL_TYPE_PREFETCH
    jmp @@success
