...
int main(int argc, char** argv) {
    ...
    std::cout << "  SUCCESS: Tokenizer loaded in " << duration.count() << " ms\n";
    ...
    auto duration_encode = std::chrono::duration_cast<std::chrono::microseconds>(end - start);
    
    std::cout << "  Tokenized to " << tokens.size() << " tokens in " << duration_encode.count() << " μs\n";
    std::cout << "  Tokens: [";
    ...
    std::cout << "  Decoded in " << duration_us.count() << " μs\n";
    std::cout << "  Output: \"" << decoded << "\"\n\n";
    
    // Test 4: Special tokens
    std::cout << "[TEST 4] Special tokens...\n";
    std::cout << "  BOS ID: " << tokenizer.GetBOSId() << "\n";
    std::cout << "  EOS ID: " << tokenizer.GetEOSId() << "\n";
    std::cout << "  UNK ID: " << tokenizer.GetUNKId() << "\n";
    std::cout << "  PAD ID: " << tokenizer.GetPADId() << "\n\n";
    ...
    std::cout << "  ✓ Tokenizer loads " << tokenizer.GetVocabSize() << " tokens\n";
