...
// CloudProviderType is now defined in cloud_config.h
...
public:
    ...
    bool deployToCloud(const QString& applicationName, const QString& version, CloudProviderType provider = AWS);
