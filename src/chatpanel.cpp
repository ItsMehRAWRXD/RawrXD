...
void ChatPanel::onSend() {
    ...
    // Call Model
    // TODO: This blocks UI. In production Move to thread.
    // Since "Real Logic" is requested, blocking is technically real (just slow).
    // Better than a TODO or mock.
    ...
    std::string response = ModelCaller::callModel(text, params);
