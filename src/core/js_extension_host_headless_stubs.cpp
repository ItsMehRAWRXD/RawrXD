...
void JSExtensionHost::bindVSCodeCommands(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeWindow(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeWorkspace(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeLanguages(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeDebug(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeTasks(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeEnv(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeExtensions(void* ctx) { (void)ctx; }
void JSExtensionHost::bindVSCodeAPI(void* ctx) { (void)ctx; }
