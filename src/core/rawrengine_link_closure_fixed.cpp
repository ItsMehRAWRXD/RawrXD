...
// Include PatchResult from header
#include "patch_result.hpp"

// Include LSPHotpatchBridge header and provide out-of-line definitions
...
// ============================================================================
// LSPHotpatchBridge out-of-line definitions - needed by auto_feature_registry.cpp
// ============================================================================

// Provide out-of-line definitions for LSPHotpatchBridge methods
...
PatchResult LSPHotpatchBridge::attach(RawrXD::LSPServer::RawrXDLSPServer*) {
...
void LSPHotpatchBridge::onHotpatchEvent(const HotpatchEvent*, void*) {}
