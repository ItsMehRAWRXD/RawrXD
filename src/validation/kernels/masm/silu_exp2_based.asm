; ============================================================================
; silu_exp2_based.asm - SiLU Activation using FAST_EXP2 (Accurate Version)
; ============================================================================
...
;   sigmoid(x) = 1 / (1 + exp(-x))
;
; This version uses FAST_EXP2 macro from math_approx.inc for accurate exp(-x)
;
; Accuracy: Max error < 1e-5 (using FAST_EXP2)
;
...
; ============================================================================
; MASM_Silu_Exp2_Based - SiLU using FAST_EXP2 for accurate sigmoid
; ============================================================================

MASM_Silu_Exp2_Based PROC FRAME
...
process_loop:
    ...
    ; For now, use FAST_EXP macro which handles the conversion
    ; FAST_EXP ymm1, ymm1, ymm2, ymm3, ymm6
    
    ; Actually, let's use FAST_EXP2 directly
    ; exp(-x) = 2^(-x * log2(e))
    ; We need to multiply by log2(e) first
