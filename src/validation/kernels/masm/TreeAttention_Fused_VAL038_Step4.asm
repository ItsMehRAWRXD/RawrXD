...
.query_loop:
    ...
    mov     r10d, 1000                  ; Safety guard: max 1000 iterations
...
.key_loop:
    ...
    ; Store marker for first iteration only
    cmp     r8d, 0
    jne     .skip_marker
    cmp     r9d, 0
    jne     .skip_marker
    mov     dword ptr [r12], 0EEEEEEEEh
    mov     dword ptr [r12+4], esi      ; Also store num_k for debugging
.skip_marker:
