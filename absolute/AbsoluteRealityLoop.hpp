...
struct AbsoluteRealityLoopMetrics {
    ...
    AbsoluteRealityLoopMetrics() = default;
};

// Main loop class
class AbsoluteRealityLoop {
public:
    // Initialization
    static bool Init(const AbsoluteRealityLoopConfig& config = AbsoluteRealityLoopConfig());
    ...
    // Configuration
    static void SetConfig(const AbsoluteRealityLoopConfig& config);
    static AbsoluteRealityLoopConfig GetConfig();
    
    // Metrics
    static AbsoluteRealityLoopMetrics GetMetrics();
...
private:
    ...
    static AbsoluteRealityLoopConfig s_config;
    static AbsoluteRealityLoopMetrics s_metrics;
