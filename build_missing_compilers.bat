...
for %%n in (
    ...
    if not exist "%OUTDIR%\%%n.exe" (
        ...
        echo     msg_banner db "%%n v1.0", 13, 10 >> "!ASMFILE!"
        echo     msg_banner_len equ $ - msg_banner >> "!ASMFILE!"
        echo     msg_ready db "[READY] %%n initialized", 13, 10 >> "!ASMFILE!"
        echo     msg_ready_len equ $ - msg_ready >> "!ASMFILE!"
        echo     msg_exit db "[EXIT] Code 0", 13, 10 >> "!ASMFILE!"
        echo     msg_exit_len equ $ - msg_exit >> "!ASMFILE!"
        echo. >> "!ASMFILE!"
        echo .code >> "!ASMFILE!"
        echo mainCRTStartup proc >> "!ASMFILE!"
        echo     sub rsp, 88 >> "!ASMFILE!"
        echo. >> "!ASMFILE!"
        echo     mov ecx, STD_OUTPUT_HANDLE >> "!ASMFILE!"
        ...
        echo     mov qword ptr [rsp+32], r9 >> "!ASMFILE!"
