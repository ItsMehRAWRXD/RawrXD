# Genesis MASM64 Build System - Working Directory Fix
# PowerShell Edition
...
# Link from VS2022 bin directory where runtime DLLs exist
Write-Host "`n[3/3] Linking unified DLL from VS2022 bin directory..." -ForegroundColor Yellow
...
Write-Host "Running linker from: $MASM_PATH"
Write-Host "Link arguments length: $($linkArgs.Length)"

# Run linker from VS2022 bin directory
$psi = New-Object System.Diagnostics.ProcessStartInfo
$psi.FileName = $LINK
$psi.Arguments = $linkArgs
$psi.WorkingDirectory = $MASM_PATH
