...
echo [BUILD] RawrXD Complete - Using Working Pattern
echo ================================================
...
"%LINK%" /DLL /DEBUG /INCREMENTAL:NO /ENTRY:DllMain /LIBPATH:"%LIB_PATH%" /OUT:"%BIN_DIR%\RawrXD_Unified.dll" /PDB:"%BIN_DIR%\RawrXD_Unified.pdb" !OBJ_LIST! kernel32.lib
