# Genesis MASM64 Build System - Using Response File
# PowerShell Edition
...
# Link from debug-pipeline context using response file
Write-Host "`n[3/3] Linking unified DLL..." -ForegroundColor Yellow

# Create response file
$rspPath = Join-Path $DEBUG_PIPE "link_genesis.rsp"
$rspLines = @(
    "/DLL",
    "/DEBUG",
    "/INCREMENTAL:NO",
...
$rspLines += "kernel32.lib"

Set-Content -Path $rspPath -Value ($rspLines -join "`r`n") -Force

Write-Host "Response file created: $rspPath"
Write-Host "Objects in response: $($objCount)"

# Run linker from debug-pipeline directory
$psi = New-Object System.Diagnostics.ProcessStartInfo
$psi.FileName = $LINK
$psi.Arguments = "@link_genesis.rsp"
