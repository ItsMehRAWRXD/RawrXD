...
echo [LINK] RawrXD Full Build - Extended from Debug Pipeline
echo ========================================================
...
echo [LINK] Linking RawrXD_Full.dll from debug-pipeline context...

REM MUST be in debug-pipeline directory
cd /d d:\rawrxd\build-debug-pipeline

echo Current directory: %CD%
echo.

REM Link with explicit object list (all 40 objects)
