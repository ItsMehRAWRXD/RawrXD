...
$Script:LlamaCppDir = "D:\OllamaModels\llama.cpp"

# Download llama.cpp
Write-Host "Fetching latest release info..."
$Script:apiUrl = "https://api.github.com/repos/ggerganov/llama.cpp/releases/latest"
$Script:release = Invoke-RestMethod -Uri $apiUrl -Headers @{"User-Agent"="PowerShell"}
$Script:windowsAsset = $release.assets | Where-Object { 
...
$Script:url = $windowsAsset.browser_download_url
Write-Host "Downloading from $url..."
$Script:zipFile = "${env:TEMP}\llama.cpp.zip"
