...
bool SandboxedTerminal::validateCommand(const QString& command, QString& blockReason)
{
    return const_cast<const SandboxedTerminal*>(this)->validateCommand(command, blockReason);
}
