...
bool StreamingGGUFLoaderQt::parseHeader() {
    ...
    if (header.version != GGUF_VERSION_MAX) {
        std::cout << "[StreamingGGUFLoaderQt] Loading legacy GGUF version "
                  << header.version << " (compat mode)" << std::endl;
    }
...
size_t StreamingGGUFLoaderQt::getTensorDataSize(GGMLType type, const std::vector<uint64_t>& shape) const {
    ...
    auto block_aligned_size = [elements](uint64_t block_elements, uint64_t block_size) -> size_t {
        uint64_t num_blocks = (elements + block_elements - 1) / block_elements;
        return static_cast<size_t>(num_blocks * block_size);
    };

    switch (type) {
        case GGMLType::F32: return elements * sizeof(float);
        case GGMLType::F16: return elements * sizeof(ggml_half);
        case GGMLType::BF16: return elements * sizeof(ggml_bf16_t);
        case GGMLType::F64: return elements * sizeof(double);
        case GGMLType::I8: return elements * sizeof(int8_t);
        case GGMLType::I16: return elements * sizeof(int16_t);
        case GGMLType::I32: return elements * sizeof(int32_t);
        case GGMLType::I64: return elements * sizeof(int64_t);
...
size_t StreamingGGUFLoaderQt::getTypeSize(GGMLType type) const {
    switch (type) {
        ...
        case GGMLType::F16: return sizeof(ggml_half);
        case GGMLType::BF16: return sizeof(ggml_bf16_t);
        case GGMLType::F64: return sizeof(double);
        case GGMLType::I8: return sizeof(int8_t);
        case GGMLType::I16: return sizeof(int16_t);
        case GGMLType::I32: return sizeof(int32_t);
        case GGMLType::I64: return sizeof(int64_t);
        ...
        case GGMLType::Q8_1: return sizeof(block_q8_1);
        ...
        case GGMLType::Q8_K: return sizeof(block_q8_K);
