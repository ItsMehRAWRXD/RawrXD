...
public:
    ...
    // Virtual methods for test mocking (override with two-argument component+message signature)
    virtual void debug(const std::string& component, const std::string& message) {
        log(LogLevel::DEBUG, "[" + component + "] " + message);
    }

    virtual void info(const std::string& component, const std::string& message) {
        log(LogLevel::INFO, "[" + component + "] " + message);
    }

    virtual void warn(const std::string& component, const std::string& message) {
        log(LogLevel::WARN, "[" + component + "] " + message);
    }

    virtual void error(const std::string& component, const std::string& message) {
