...
#        ifdef GGML_BUILD
#            define GGML_API extern __declspec(dllexport)
#        else
#            define GGML_API extern __declspec(dllimport)
#        endif
#    else
...
extern "C" {
    ...
    GGML_API void        ggml_fp32_to_fp16_row(const float *, ggml_fp16_t *, int64_t);
        ...
        // ggml_bf16_t is defined in ggml-common.h when GGML_COMMON_DECL_C/CPP is set
#if !defined(GGML_COMMON_DECL) && !defined(GGML_BF16_T_DEFINED)
        typedef struct { uint16_t bits; } ggml_bf16_t;
#define GGML_BF16_T_DEFINED
#endif
