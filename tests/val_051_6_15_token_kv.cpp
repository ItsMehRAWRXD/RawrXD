// ============================================================================
// VAL-051.6 — 15-Token Autoregressive / KV Stability Gate
//
// No external dependencies.
// Uses the existing RawrXD production inference path.
//
// Acceptance:
//   - exactly 15 generated tokens
//   - valid vocabulary IDs
//   - finite logits
//   - finite/non-zero hidden state
...
int executeGate(const char* model_path)
{
    ...
    std::cout
        << "============================================================\n"
        << "VAL-051.6 — 15 TOKEN KV STABILITY GATE\n"
        << "============================================================\n"
        << "MODEL=" << model_path << "\n"
        << "TARGET=15\n"
        << "PROMPT=" << prompt << "\n"
    ...
    writeEvidence(
        gate,
        "evidence/VAL-051.6_15_TOKEN_EVIDENCE.json");
