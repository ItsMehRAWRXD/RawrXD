...
@@check_size:
    cmp (MEMORY_PATCH ptr [rbx]).Size, 0
...
@@nf4_decompress:
    ...
    mov r12, (MEMORY_PATCH ptr [rbx]).Size           ; Source size in bytes
...
@@prefetch_operation:
    ...
    mov r12, (MEMORY_PATCH ptr [rbx]).Size
...
@@standard_copy:
    ...
    mov r8, (MEMORY_PATCH ptr [rbx]).Size
...
@@success:
    ...
    mov rax, pPatch
    mov rcx, (MEMORY_PATCH ptr [rax]).Size
