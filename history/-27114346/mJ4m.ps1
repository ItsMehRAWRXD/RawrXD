...
$Script:linkArgs = $linkArgsBase + "@`"$responseFile`""
    ...
    # Use temp files to avoid pipe deadlock with large output
...
$Script:proc = Start-Process -FilePath $Linker -ArgumentList $argString -NoNewWindow -Wait -PassThru -RedirectStandardOutput $stdoutFile -RedirectStandardError $stderrFile
