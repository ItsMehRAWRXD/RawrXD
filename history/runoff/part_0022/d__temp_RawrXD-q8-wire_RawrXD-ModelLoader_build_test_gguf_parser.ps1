...
$Script:qtPath = "C:\Qt\6.7.3\msvc2022_64"
$Script:qtBin = "$qtPath\bin"
$Script:qtInclude = "$qtPath\include"
$Script:qtLib = "$qtPath\lib"
...
$Script:compileCmd = "cl /EHsc /std:c++17 /Zc:__cplusplus /permissive- /MD /Fe:test_gguf_parser.exe $($includes -join ' ') $($sources -join ' ') /link $($libs -join ' ')"
