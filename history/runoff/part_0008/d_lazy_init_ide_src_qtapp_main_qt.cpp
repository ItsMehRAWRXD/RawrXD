...
#include "digestion_system_integration.h"
...
int main(int argc, char* argv[])
{
    try {
        ...
        // Initialize Digestion Reverse Engineering System
        qDebug() << "[DIGESTION] Initializing Agentic Digestion System...";
        DigestionSystemIntegration::instance()->initializeForDirectory(
