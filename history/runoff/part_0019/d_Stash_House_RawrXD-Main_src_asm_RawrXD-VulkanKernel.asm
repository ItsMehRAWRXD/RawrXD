...
CreateRMSNormPipeline PROC
    ...
    mov [rsi].VkComputePipelineCreateInfo.stageInfo.stage, VK_SHADER_STAGE_COMPUTE_BIT
    mov [rsi].VkComputePipelineCreateInfo.stageInfo.module, [rbx].ShaderModule.module
    mov [rsi].VkComputePipelineCreateInfo.stageInfo.pName, c_str("main")
