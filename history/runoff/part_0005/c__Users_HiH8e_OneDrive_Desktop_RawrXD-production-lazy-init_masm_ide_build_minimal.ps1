...
# Start with working GUI modules (tabs + file explorer + orchestra + menu)
$Script:workingFiles = @('masm_main','engine','window','config_manager','orchestra','tab_control_minimal','file_explorer','menu_system','ui_layout','entry')
$Script:compiledObjs = @()
