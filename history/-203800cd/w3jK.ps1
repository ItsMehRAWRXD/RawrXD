...
function Start-HTMLPowerShellIDE {
    Write-Host "🚀 Starting HTML + PowerShell Hybrid IDE..." -ForegroundColor Cyan
    Write-Host "📊 Optimized for: ${Width}x${Height}" -ForegroundColor Yellow
    
    # Create high-DPI aware form
    [System.Windows.Forms.Application]::EnableVisualStyles()
    [System.Windows.Forms.Application]::SetCompatibleTextRenderingDefault($false)
    
    $form = New-Object System.Windows.Forms.Form
    $form.Text = "RawrXD HTML+PowerShell IDE - 4K Optimized"
    ...
    $form.add_FormClosing({
        Write-Host "👋 Shutting down HTML+PowerShell IDE..." -ForegroundColor Yellow
    })
    
    $form.add_Shown({
        Write-Host "✅ HTML+PowerShell IDE is ready!" -ForegroundColor Green
    })
