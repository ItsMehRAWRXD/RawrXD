...
# Default shortcuts
$shortcutsList = @()
$shortcutsList += @{ action = "new_file"; keys = "Ctrl+N" }
$shortcutsList += @{ action = "open_file"; keys = "Ctrl+O" }
$shortcutsList += @{ action = "save_file"; keys = "Ctrl+S" }
$shortcutsList += @{ action = "save_as"; keys = "Ctrl+Shift+S" }
$shortcutsList += @{ action = "close_tab"; keys = "Ctrl+W" }
$shortcutsList += @{ action = "find"; keys = "Ctrl+F" }
$shortcutsList += @{ action = "replace"; keys = "Ctrl+H" }
$shortcutsList += @{ action = "goto_line"; keys = "Ctrl+G" }
$shortcutsList += @{ action = "build"; keys = "Ctrl+B" }
$shortcutsList += @{ action = "run"; keys = "F5" }
$shortcutsList += @{ action = "debug"; keys = "F9" }
$shortcutsList += @{ action = "terminal"; keys = "Ctrl+``" }
$shortcutsList += @{ action = "command_palette"; keys = "Ctrl+Shift+P" }
$shortcutsList += @{ action = "audit_dashboard"; keys = "Ctrl+Shift+A" }
$shortcutsList += @{ action = "voice_chat"; keys = "Ctrl+Shift+V" }
$shortcutsList += @{ action = "cot_review"; keys = "Ctrl+Shift+R" }
