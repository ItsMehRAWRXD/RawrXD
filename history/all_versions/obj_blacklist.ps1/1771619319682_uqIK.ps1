...
# ==========================================================
# Export for use by genesis_build.ps1 / genesis_link_clean.ps1
# ==========================================================
Export-ModuleMember -Function Get-CleanObjects, Test-ValidCOFF, Invoke-QuarantineCorrupt -ErrorAction SilentlyContinue
