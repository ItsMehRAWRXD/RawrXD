...
EXTERN GetCurrentProcess : PROTO
EXTERN OpenProcessToken : PROTO
EXTERN LookupPrivilegeValueW : PROTO
EXTERN AdjustTokenPrivileges : PROTO
EXTERN CreateFileW : PROTO
EXTERN CreateFileMappingW : PROTO
EXTERN MapViewOfFileEx : PROTO
EXTERN UnmapViewOfFile : PROTO
EXTERN VirtualLock : PROTO
EXTERN VirtualUnlock : PROTO
EXTERN CloseHandle : PROTO
EXTERN GetFileSize : PROTO
...
size_ok:
    ...
    mov qword ptr [rsp+32], r13         ; dwMaximumSizeLow
