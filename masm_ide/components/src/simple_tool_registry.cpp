...
MasmToolRegistry::MasmToolRegistry(QObject* parent)
    : QObject(parent)
{
}

MasmToolRegistry::~MasmToolRegistry() = default;

void MasmToolRegistry::registerTool(const ToolDef& toolDef)
{
...
void MasmToolRegistry::registerTool(const QString& name, const QString& description,
...
QJsonObject MasmToolRegistry::executeTool(const QString& toolName, const QJsonObject& parameters)
{
...
QJsonObject MasmToolRegistry::executeToolCall(const QJsonObject& toolCall)
{
...
bool MasmToolRegistry::hasTool(const QString& name) const
{
    return m_tools.contains(name);
}

MasmToolRegistry::ToolDef MasmToolRegistry::getToolDef(const QString& name) const
{
    return m_tools.value(name);
}

QStringList MasmToolRegistry::getToolNames() const
{
    return m_tools.keys();
}

QJsonArray MasmToolRegistry::getToolsAsJsonArray() const
{
    QJsonArray tools;
