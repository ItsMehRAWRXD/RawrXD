; ============================================================================
; Sovereign_LayerNorm_Simple.asm - Simple Layer Normalization
; ============================================================================
; Uses 5 parameters in registers (no stack params needed)
; RCX=input, RDX=output, R8=gamma, R9=beta, [RSP+40]=n_elements
; ============================================================================
...
layer_norm_f32 PROC EXPORT FRAME
    ...
    ; Load n_elements and epsilon from stack
    ; After 8 pushes (64 bytes) + sub rsp,64 = 128 bytes
    ; Original [RSP+40] is now at [RBP+128+40] = [RBP+168]
    ; Original [RSP+48] is now at [RBP+128+48] = [RBP+176]
    mov     rax, QWORD PTR [rbp+168]    ; n_elements
    mov     QWORD PTR [rbp+32], rax     ; save n_elements
    movss   xmm0, DWORD PTR [rbp+176]   ; epsilon
