@echo off
REM ============================================================================
REM build_oracle_fixed.bat - Complete Oracle Build with Fixed Paths
REM ============================================================================
...
REM Add Windows SDK um and shared folders (needed for windows.h)
...
link.exe /SUBSYSTEM:CONSOLE /OUT:Sovereign_Transformer_Oracle.exe obj\Sovereign_Transformer_Oracle.obj obj\Sovereign_KernelDispatch.obj Sovereign_RMSNorm.obj Sovereign_RoPE.obj Sovereign_ResidualAdd.obj Sovereign_LayerNorm.obj Sovereign_Q4K_Dequant.obj msvcrt.lib kernel32.lib
