...
set UR=..\..\UNIVERSAL_STREAMER_RESIDENCY_001
set DUO=..\..\DOUBLEUNDEROVER_RESIDENCY_AUTHORITY_001
set ENT=..\..\ENTERPRISE_POST_PRODUCT_TOP15_001\RAWRXD_ENTERPRISE_POST_PRODUCT_X64_MASM_NODEP_TOP15
...
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_load.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_dev.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_import.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_sync.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_vis.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_drop.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_consume.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_pipe.c || exit /b 1
cl /nologo /TC /O2 /W3 /MT /I. /I"%VKI%" /c ss_vk_embd.c || exit /b 1
...
link /nologo /subsystem:console smoke_phase.obj ss_d3d12_bridge.obj ss_product_phase.obj ^
  ...
  ss_vk_load.obj ss_vk_dev.obj ss_vk_import.obj ss_vk_sync.obj ss_vk_vis.obj ss_vk_drop.obj ss_vk_consume.obj ^
  ss_vk_pipe.obj ss_vk_embd.obj ^
...
cl /nologo /TC /O2 /W3 /MT /D_CRT_SECURE_NO_WARNINGS /I. /I"%UR%" /I"%DUO%" /I"%ENT%" /c ss_product_e2e.c || exit /b 1
